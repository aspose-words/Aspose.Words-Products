---
title: API de palabras de C++ | Análisis y conversión de creación de documentos 
weight: 8250
url: /es/cpp/ 
description: Biblioteca de procesamiento de documentos de Word C++ para generar, editar, convertir y representar un documento usando C++. Lea, escriba y analice dinámicamente formatos de Word como DOC, DOCX u otros formatos como PDF, RTF, ODT, TXT, MOBI, HTML, JPG, PNG.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API de procesamiento de documentos de Word C++" h2="Genere, edite, convierta y represente documentos de Microsoft Word en la aplicación C++ sin necesidad de Microsoft Word." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-cpp.svg" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/words/cpp" >}}
...
<p><strong>Aspose.Words for C++</strong> es una API avanzada de procesamiento de documentos de Word para realizar una amplia gama de tareas de procesamiento. La API de Word proporciona formato de documentos, manipulación, combinación de correspondencia, marcas de agua y muchas más capacidades directamente dentro de sus propias aplicaciones C++ sin necesidad de Microsoft Word.</p>
<p>La API de Aspose.Words es compatible con la mayoría de los formatos de Microsoft Word y puede representar las páginas del documento en varios formatos de imagen. Por lo tanto, puede trabajar con documentos en formato DOC, DOCX, PDF, RTF, DOT, DOTX, DOTM, DOCM, FlatOPC, ODT, OTT, HTML, MHTML, MOBI, TXT, XPS, PS, TIFF, JPEG, PNG, BMP, SVG, EMF, GIF, PCL, EPUB, XML, XAML y más. Puedes ver <a href="https://docs.aspose.com/words/cpp/supported-document-formats/">la lista completa de formatos soportados</a>.</p>
<h2 class="h2title">Functionality of Aspose.Words for C++</h2>
<p>Aspose.Words es una biblioteca de C++ independiente. No necesita instalar aplicaciones adicionales para que su código C++ funcione. Esta API de C++ se basa en el <a href="https://docs.aspose.com/words/cpp/aspose-words-document-object-model/">Modelo de objeto de documento (DOM)</a> para acceder a los nodos y elementos del documento.</p>
{{< /blocks/products/pf/i18n/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/i18n/carousel >}}

{{< blocks/products/pf/carousel-item h3="de un vistazo" description="Una vista genérica de las capacidades de la API." >}}
<div class="diagram1 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Biblioteca de procesamiento de textos C++" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="La biblioteca es totalmente compatible con las aplicaciones C++ desarrolladas en las siguientes plataformas que tienen [Requisitos del sistema](https://docs.aspose.com/words/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de manipulación de documentos de Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.Words para C++ es compatible con los más populares [Formatos de archivo de procesamiento de textos](https://docs.aspose.com/words/cpp/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de programación de palabras en C++" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/convert-a-document/">Convertir un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/rendering/">Renderizar un documento a formatos de diseño fijo</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/compare-documents/">Comparar Documentos</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/clone-a-document/">Clonar un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/insert-and-append-documents/">Unir documentos: insertar y adjuntar</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/split-a-document/">Dividir archivos</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/find-and-replace/">Buscar y reemplazar texto</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/protect-or-encrypt-a-document/">Proteger o cifrar un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-digital-signatures/">Trabajar con firmas digitales</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/mail-merge-and-reporting/">Combinación de correspondencia e informes</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-watermark/">Agregar marca de agua a un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-tables/">Trabajar con tablas</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-fields/">Insertar, actualizar o eliminar campos</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/programming-with-documents/">Dar formato a todos los elementos del documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-comments/">Trabajar con comentarios y revisiones</a>
    </p>
   </div>
   <div>
   <p>
     Tenga en cuenta que la lista no está completa y puede encontrar más funciones y descripciones en la <a href="https://docs.aspose.com/words/cpp/developer-guide/">documentation</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/words/cpp/" >}}
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-words/Aspose.Words-for-C" >}}
{{< blocks/products/pf/slr-element name="Referencias de API" href="https://apireference.aspose.com/words/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Words para C++?" tabId="success-stories" >}}

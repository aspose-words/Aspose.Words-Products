---
title: Exportar relatórios em arquivos do Word no JasperReports e JasperServer 
weight: 10660
url: /pt/jasperreports/ 
description: Exporte relatórios do Jasper Reports e JasperServer no Word DOC Office Open XML OOXML DOCX RTF ODT HTML MHTML e formatos TXT
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extensão JasperReports para exportar relatórios em formato Word" h2="Exporte relatórios para formatos Word e HTML de JasperReports e JasperServer." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-jasperreports.svg" pfName="Aspose.Words" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/words/jasperreports" >}}
...
<p>
 Aspose.Words for JasperReports é a única solução no mercado que permite exportar relatórios do JasperReports e JasperServer para documentos Microsoft Word (DOC), Office Open XML (OOXML, DOCX), Rich Text Format (RTF), OpenDocument Text ( ODT), página da Web (HTML) e formatos de texto simples (TXT) sem usar o Microsoft Word. Todos os recursos de relatório com o mais alto grau de precisão podem ser convertidos em arquivo do Microsoft Word.
</p>
...
{{< blocks/products/pf/carousel-item h3="Num relance" description="Os recursos do Aspose.Words para JasperReports." >}}
...
{{< blocks/products/pf/carousel-item h3="Independência da plataforma" description="Aspose.Words para JasperReports suporta J2SE, JasperReports e JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
  ...
  <div class="d1-col d1-right">
   ...
   <header style="padding-left: 0px;">
    ...
    JasperServer 3.7.1 ou mais alto
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports Server 7.1.0 ou mais alto
   </header>
  </div>
  <!--/right-->
 </div>
...
{{< blocks/products/pf/carousel-item h3="Formatos de arquivo suportados" description="Aspose.Words for JasperReports suporta os mais populares processamento de texto, texto e web [formatos de arquivo](https://docs.aspose.com/words/jasperreports/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Exportador JasperReports para Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     Suporte para os formatos mais populares do Microsoft Word
    </h2>
    <p>
     Aspose.Words para JasperReports permite exportar relatórios como documentos DOC e DOCX do JasperReports e JasperServer. Em comparação com o RTF, esses formatos oferecem várias vantagens, como tamanho de arquivo menor, maior formatação de conteúdo e facilidade de edição pelos usuários finais.
    </p>
    <p>
     Além dos formatos do Microsoft Word, o Aspose.Words for JasperReports oferece a capacidade de exportar os relatórios nos formatos RTF, ODT, HTML e TXT.
    </p>
   </div>
   <!--
...
<h2 class="h2title">Easy & Implantação leve</h2>
...
-->
   <div class="col-lg-12">
    ...
    <p>
     O Aspose.Words para JasperReports exporta os relatórios para documentos do Microsoft Word de forma que o resultado pareça idêntico ao design original do relatório produzido pelo designer de relatório JasperReports integrado. Todos os recursos de relatório são convertidos no mais alto grau de precisão para que os documentos do Microsoft Word pareçam o mais próximo possível do design original.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words para JasperReports exporta documentos de layout de fluxo. Isso significa que os documentos consistem em "
     <strong>
      normal
     </strong>
     " parágrafos, tabelas e imagens que são fáceis de editar no Microsoft Word, se necessário. O exportador RTF JasperReports integrado produz documentos que consistem em quadros de texto posicionados, o que torna a edição pelos usuários finais uma tarefa menos intuitiva.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words para JasperReports é construído usando código gerenciado que nunca precisa que o Microsoft Word seja instalado na máquina para trabalhar com formatos de documentos do Word. É uma alternativa perfeita de automação do Microsoft Word em termos de recursos suportados, segurança, estabilidade, escalabilidade, velocidade e preço.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Documentação" href="https://docs.aspose.com/words/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Words para JasperReports?" tabId="success-stories" >}}

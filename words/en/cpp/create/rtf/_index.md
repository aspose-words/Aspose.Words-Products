...
{{< blocks/products/pf/upper-banner h1="Create RTF File via C++" h2="Native and high performance Microsoft Word RTF documents creation programmatically using C++ library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="RTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RTF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Create RTF via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a Word RTF file using C++." offSpacer="" %}}

```cs
// Initializing a Document.
System::SharedPtr<Document> rtf = System::MakeObject<Document>();
// Document builder for adding content within the document.
System::SharedPtr<DocumentBuilder> bldr = System::MakeObject<DocumentBuilder>(rtf);
// Add all relevant content
bldr->Writeln(u"relevant content!"); 
// Save the document to any specified location.
rtf->Save(u"document.rtf"); 

// Enhance the code to edit or update the created Word RTF file
...
A Document Processing Library to perform a wide range of document creation, management and manipulation tasks including RTF generation, editing, conversion, rendering and printing. C++ Word library supports all of word-processing formats as well as allows exporting or converting RTF to PDF, HTML, fixed-layout and most commonly used image & multimedia formats.

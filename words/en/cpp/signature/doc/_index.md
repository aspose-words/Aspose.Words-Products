---
title: e-Sign DOC Documents via C++ 
weight: 6120

description: C++ example code to eSgin DOC documents on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---
...
System::String outputPath = outputDataDir + u"SigningSignatureLine.SimpleDocumentSigning_out.doc";
DigitalSignatureUtil::Sign(inputDataDir + u"Document.Signed.doc", outputPath, certHolder);  

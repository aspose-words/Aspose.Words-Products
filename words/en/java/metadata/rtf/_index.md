...
{{< blocks/products/pf/upper-banner h1="Extract RTF Metadata via Java" h2="Build your own Java apps to add, edit, remove or extract metadata from Microsoft Word RTF files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Extract RTF Metadata Using Java" %}}
 ...
 In order to get Microsoft Word RTF file metadata, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Extract Metadata of Microsoft Word RTF via Java" %}}

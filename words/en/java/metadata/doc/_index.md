...
{{% blocks/products/pf/agp/content h2="How to Extract DOC Metadata Using Java" %}}
 ...
 In order to get Microsoft Word DOC file metadata, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Extract Metadata of Microsoft Word DOC via Java" %}}

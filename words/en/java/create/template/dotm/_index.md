---
title: Generate Word DOTM documents from template via Java 
weight: 7690
url: /java/create/template/dotm/ 
description: Java Sample code for creating template based DOTM documents. Use it for automated generation of Word DOTM files within Java based desktop or web application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Create Template Based DOTM Files via Java" h2="Native and high performance Microsoft Word DOTM document generation from templates programmatically using Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOTM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Create Word DOTM File Using Template via Java" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to creat DOTM files from template using ReportingEngine within running Word Automation applications for data processing in just a few lines of code. Reporting Engine supports different data sources including XML, JSON and CSV data.
...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a Word DOTM file from template using Java." offSpacer="" %}}
...
///
// Create Document object and initialize with DOTM template.
...
// Build report.
engine.buildReport(dotm, sender, "s");

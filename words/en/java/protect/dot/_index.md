...
{{% blocks/products/pf/agp/content h2="How to Secure DOT File Using Java" %}}
 ...
 In order to protect Microsoft Word DOT file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Protect Microsoft Word DOT Files via Java" %}}

...
{{% blocks/products/pf/agp/content h2="How to Secure DOCX File Using Java" %}}
 ...
 In order to protect Microsoft Word DOCX file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Protect Microsoft Word DOCX Files via Java" %}}

...
{{% blocks/products/pf/agp/content h2="How to Secure DOTX File Using Java" %}}
 ...
 In order to protect Microsoft Word DOTX file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Protect Microsoft Word DOTX Files via Java" %}}

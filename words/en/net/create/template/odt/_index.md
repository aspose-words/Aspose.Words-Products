...
{{< blocks/products/pf/upper-banner h1="Create Template Based ODT Files via C#" h2="Native and high performance Microsoft Word ODT document generation from templates programmatically using server side .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Create Word ODT File Using Template via C#" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to creat ODT files from template using ReportingEngine within running Word Automation applications for data processing in just a few lines of code. Reporting Engine supports different datasources including XML and JSON data.
...
1.  Save created Word ODT file using Save() method.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before **creating Microsoft Word ODT files from template dynamically** Just make sure that system have Microsoft Windows or a compatible OS with .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms as well as development environment like Microsoft Visual Studio. 
...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a Word ODT file from template using C#." offSpacer="" %}}
...
engine.BuildReport(odt, sender, "sender");

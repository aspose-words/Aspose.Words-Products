...
{{< blocks/products/pf/i18n/upper-banner h1="C++ 워드 문서 처리 API" h2="Microsoft Word 없이도 C++ 애플리케이션에서 Microsoft Word 문서를 생성, 편집, 변환 및 렌더링할 수 있습니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-cpp.svg" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/words/cpp" >}}
...
<p><strong>Aspose.Words for C++</strong> 다양한 처리 작업을 수행하는 고급 Word 문서 처리 API입니다. Words' API는 Microsoft Word 없이도 문서 서식 지정, 조작, 편지 병합, 워터마킹 및 훨씬 더 많은 기능을 자체 C++ 응용 프로그램 내에서 직접 제공합니다.</p>
<p>Aspose.Words API는 대부분의 Microsoft Word 형식을 지원하며 문서 페이지를 여러 이미지 형식으로 렌더링할 수 있습니다. 따라서 DOC, DOCX, PDF, RTF, DOT, DOTX, DOTM, DOCM, FlatOPC, ODT, OTT, HTML, MHTML, MOBI, TXT, XPS, PS, TIFF, JPEG, PNG, BMP, SVG, EMF, GIF, PCL, EPUB, XML, XAML 등. 너는 볼 수있어 <a href="https://docs.aspose.com/words/cpp/supported-document-formats/">지원되는 형식의 전체 목록</a>.</p>
<h2 class="h2title">Functionality of Aspose.Words for C++</h2>
<p>Aspose.Words는 독립형 C++ 라이브러리입니다. C++ 코드가 작동하도록 하기 위해 추가 응용 프로그램을 설치할 필요가 없습니다. 이 C++ API는 <a href="https://docs.aspose.com/words/cpp/aspose-words-document-object-model/">문서 개체 모델(DOM)</a> 문서 노드 및 요소에 액세스합니다.</p>
{{< /blocks/products/pf/i18n/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/i18n/carousel >}}

{{< blocks/products/pf/carousel-item h3="한눈에" description="API의 기능에 대한 일반적인 보기입니다." >}}
<div class="diagram1 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ 워드 프로세싱 라이브러리" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="플랫폼 독립성" description="라이브러리는 다음 플랫폼에서 개발된 C++ 애플리케이션을 완벽하게 지원합니다. [시스템 요구 사항](https://docs.aspose.com/words/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Word 문서 조작 API" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description="Aspose.Words for C++는 가장 인기 있는 지원 [워드 프로세싱 파일 형식](https://docs.aspose.com/words/cpp/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ 워드 프로그래밍 API" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/convert-a-document/">문서 변환</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/rendering/">문서를 고정 레이아웃 형식으로 렌더링</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/compare-documents/">문서 비교</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/clone-a-document/">문서 복제</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/insert-and-append-documents/">문서 결합: 삽입 및 추가</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/split-a-document/">파일 분할</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/find-and-replace/">텍스트 찾기 및 바꾸기</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/protect-or-encrypt-a-document/">문서 보호 또는 암호화</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-digital-signatures/">디지털 서명 작업</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/mail-merge-and-reporting/">편지 병합 및 보고</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-watermark/">문서에 워터마크 추가</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-tables/">테이블 작업</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-fields/">필드 삽입, 업데이트 또는 제거</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/programming-with-documents/">모든 문서 요소 서식 지정</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-comments/">주석 및 수정본 작업</a>
    </p>
   </div>
   <div>
   <p>
     목록이 완전하지 않으며 더 많은 기능과 설명을 찾을 수 있습니다. <a href="https://docs.aspose.com/words/cpp/developer-guide/">documentation</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="선적 서류 비치" href="https://docs.aspose.com/words/cpp/" >}}
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-words/Aspose.Words-for-C" >}}
{{< blocks/products/pf/slr-element name="API 참조" href="https://apireference.aspose.com/words/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="왜 Aspose.Words for C++인가?" tabId="success-stories" >}}

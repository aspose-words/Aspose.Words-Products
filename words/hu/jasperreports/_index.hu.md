...
<p>
 Az Aspose.Words for JasperReports az egyetlen olyan megoldás a piacon, amely lehetővé teszi a jelentések exportálását a JasperReportsból és a JasperServerből Microsoft Word dokumentumba (DOC), Office Open XML-be (OOXML, DOCX), Rich Text Format (RTF), OpenDocument Text ( ODT), weblap (HTML) és egyszerű szöveges (TXT) formátumok Microsoft Word használata nélkül. Minden jelentési funkció a legnagyobb pontossággal konvertálható Microsoft Word fájlba.
</p>
...
{{< blocks/products/pf/carousel-item h3="Ránézésre" description="Az Aspose.Words for JasperReports szolgáltatásai." >}}
<div class="diagram1 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="A JasperReports a Words Exporternek" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platformfüggetlenség" description="Az Aspose.Words for JasperReports támogatja a J2SE, a JasperReports és a JasperServer szolgáltatást." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
  ...
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 3.0 vagy magasabb
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
    </i>
    JasperServer 3.7.1 vagy magasabb
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports Server 7.1.0 vagy magasabb
   </header>
  </div>
  <!--/right-->
 </div>
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="Az Aspose.Words for JasperReports támogatja a legnépszerűbb szövegszerkesztési, szöveg- és webes alkalmazásokat [fájlformátumok](https://docs.aspose.com/words/jasperreports/supported-document-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     A legnépszerűbb Microsoft Word formátumok támogatása
    </h2>
    <p>
     Az Aspose.Words for JasperReports lehetővé teszi a jelentések DOC- és DOCX-dokumentumként történő exportálását a JasperReportsból és a JasperServerből. Az RTF-hez képest ezek a formátumok számos előnnyel járnak, például kisebb fájlméretet, megnövelt tartalomformázást és a végfelhasználók általi könnyű szerkesztést.
    </p>
    <p>
     A Microsoft Word formátumok mellett az Aspose.Words for JasperReports lehetőséget kínál a jelentések RTF, ODT, HTML és TXT formátumban történő exportálására.
    </p>
   </div>
   <!--
...
<h2 class="h2title">Easy & Könnyű telepítés</h2>
...
-->
   <div class="col-lg-12">
    ...
    <p>
     Az Aspose.Words for JasperReports a jelentéseket Microsoft Word dokumentumokba exportálja oly módon, hogy az eredmény megegyezzen a beépített JasperReports jelentéstervező által készített eredeti jelentéstervvel. Az összes jelentésfunkciót a legmagasabb fokú pontosságra konvertálják, hogy a Microsoft Word dokumentumok a lehető legközelebb álljanak az eredeti tervhez.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Az Aspose.Words for JasperReports folyamatelrendezési dokumentumokat exportál. Ez azt jelenti, hogy a dokumentumok a következőkből állnak "
     <strong>
      Normál
     </strong>
     " bekezdések, táblázatok és képek, amelyek szükség esetén könnyen szerkeszthetők a Microsoft Wordben. A beépített JasperReports RTF exportőr elhelyezett szövegkeretekből álló dokumentumokat állít elő, így a végfelhasználók szerkesztése kevésbé intuitív feladat.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Az Aspose.Words for JasperReports felügyelt kóddal készült, amelynek soha nem kell Microsoft Word-et telepítenie a gépre, hogy Word dokumentumformátumokkal működjön. Ez egy tökéletes Microsoft Word automatizálási alternatíva a támogatott funkciók, biztonság, stabilitás, méretezhetőség, sebesség és ár szempontjából.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/words/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Miért az Aspose.Words a JasperReports számára?" tabId="success-stories" >}}

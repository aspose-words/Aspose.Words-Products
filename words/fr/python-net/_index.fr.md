---
title: API de traitement de documents Word Python – Aspose 
weight: 2200
url: /fr/python-net/
description: Bibliothèque Python pour travailler avec des fichiers Microsoft Word. Créer modifier convertir DOCX DOC RTF PDF EPUB WordML ODT HTML Texte et bien d'autres formats.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API Python pour traiter les documents Word" h2="Créez, modifiez, affichez et convertissez des fichiers Word dans plusieurs formats à l'aide de Python. Générez également des rapports et visualisez vos données. Tout cela sans utiliser de logiciel externe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-python.svg" pfName="Aspose.Words" subTitlepfName="for Python" downloadUrl="https://downloads.aspose.com/words/python" >}}
...
<p><strong>Aspose.Words for Python via .NET</strong> est un package conçu pour lire et manipuler des documents de différents types, avec un accent principal sur les documents Microsoft Word (DOC, DOCX, ODT), PDF et Web (HTML, Markdown). Notre bibliothèque contient plus de 100 classes Python pour gérer les opérations de bas niveau derrière le traitement des documents et le formatage des données. Ainsi, Aspose.Words offre aux développeurs Python une opportunité unique d'implémenter l'automatisation de documents basée sur des scripts.</p>
<p>Avec l'avènement du matériel informatique puissant au cours des dernières décennies, Python est devenu un langage de programmation largement utilisé dans le développement Web (cadres Django, Flask, Pyramid), les tâches scientifiques et l'analyse de données. L'utilité de Python découle d'un vaste écosystème de packages tiers. Fourni avec un grand nombre de bibliothèques en développement progressif, Python est considéré comme le meilleur choix pour le développement rapide de logiciels.</p>
<p>L'équipe Aspose.Words a décidé de suivre les dernières tendances de programmation et de fournir à la communauté Python un logiciel professionnel pour traiter DOC, DOCX, PDF, RTF, DOT, DOTX, DOTM, DOCM, FlatOPC, ODT, OTT, HTML, MHTML, MOBI, TXT, XPS, PS, TIFF, JPEG, PNG, BMP, SVG, EMF, GIF, PCL, EPUB, XML, XAML et autres formats de fichiers. Tu peux voir <a href="https://docs.aspose.com/words/python-net/supported-document-formats/">la liste complète des formats pris en charge</a>.</p>
<p><i>Noter:</i> selon TIOBE Programming Index, qui reflète la popularité des langages de programmation, Python est aujourd'hui le langage de programmation numéro un.</p>
<h2 class="h2title">Fonctionnalité de Aspose.Words pour Python via .NET</h2>
<p>Aspose.Words est une bibliothèque Python autonome. Vous n'avez pas besoin d'installer de suite bureautique pour que votre code Python fonctionne. Cette API Python s'appuie sur <a href="https://docs.aspose.com/words/python-net/aspose-words-document-object-model/">Modèle d'objet de document (DOM)</a> pour accéder aux nœuds et aux éléments du document.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<div class="diagram1 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de traitement de texte Python" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-python.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Indépendance de la plate-forme" description="L'API Python Word est compatible avec toutes les principales plates-formes, y compris les suivantes." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de manipulation de documents Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-python.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formats de fichiers pris en charge" description="Aspose.Words pour Python via.NET prend en charge le populaire [Formats de fichier de traitement de texte](https://docs.aspose.com/words/python-net/supported-document-formats/)  énumérés ci-dessous." >}}
...
<li>MOBI</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API de programmation Python Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-python.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/convert-a-document/">Convertir un document</a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/rendering/">Rendu d'un document dans des formats à mise en page fixe</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/compare-documents/">Comparer des documents</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/clone-a-document/">Cloner un document</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/insert-and-append-documents/">Joindre des documents : insérer et ajouter</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/split-a-document/">Diviser les fichiers</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/find-and-replace/">Rechercher et remplacer du texte</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/protect-or-encrypt-a-document/">Protéger ou chiffrer un document</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/working-with-digital-signatures/">Travailler avec des signatures numériques</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/mail-merge-and-reporting/">Mail Merge and Rapports</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/working-with-watermark/">Ajouter un filigrane à un document</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/working-with-tables/">Travailler avec des tableaux</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/linq-reporting-engine/">LINQ Rapports Engine</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/programming-with-documents/">Mettre en forme tous les éléments du document</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/working-with-comments/">Travailler avec des commentaires et des révisions</a>
    </p>
   </div>
   <div>
   <p>
     Veuillez noter que la liste n'est pas complète et que vous pouvez trouver plus de fonctionnalités et de descriptions dans le <a href="https://docs.aspose.com/words/python-net/developer-guide/">documentation</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <ul>
	  <li>Compatible avec Python 3.5, 3.6, 3.7, 3.8 et 3.9</li>
	  <li>Si vous écrivez du code Python sous Linux, jetez un œil à <a href="https://docs.aspose.com/words/python-net/system-requirements/">exigences supplémentaires pour Linux</a></li>
    </ul>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>Utilisez <strong>pip</strong> pour installer notre bibliothèque Python pour le traitement de documents Word à partir du <a href="https://pypi.org/project/aspose-words/">Référentiel PyPI</a>:
...
doc.save("Output.html")
   ...
   <p>
     Voir <a href="https://docs.aspose.com/words/python-net/convert-a-document/">la rubrique conversion</a> pour plus de détails.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Actuellement, nous utilisons Aspose.Words pour .NET pour générer nos factures, reçus, fiches de paie et nous avons l'intention d'en faire la «plate-forme» pour tous nos besoins de traitement de texte de SCINTRA.
 <em>
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-words/Aspose.Words-for-Python-via-.NET" >}}
{{< blocks/products/pf/slr-element name="Références API" href="https://docs.aspose.com/words/python-net/" >}}
...
{{< blocks/products/pf/slr-element name="Notes de version" href="https://docs.aspose.com/words/python-net/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Words pour Python via.NET ?" tabId="success-stories" >}}

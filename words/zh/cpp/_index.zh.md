---
title: C++ Word API |文档创建解析和转换 
weight: 8250
url: /zh/cpp/ 
description: C++ Word 文档处理库，用于使用 C++ 生成、编辑、转换和呈现文档。动态读取、写入和解析 DOC、DOCX 等 Word 格式或 PDF、RTF、ODT、TXT、MOBI、HTML、JPG、PNG 等其他格式。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ Word 文档处理 API" h2="在 C++ 应用程序中生成、编辑、转换和呈现 Microsoft Word 文档，无需 Microsoft Word。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-cpp.svg" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/words/cpp" >}}
...
<p><strong>Aspose.Words for C++</strong> 是一种高级 Word 文档处理 API，用于执行各种处理任务。 Words 的 API 直接在您自己的 C++ 应用程序中提供文档格式化、操作、邮件合并、水印和更多功能，而无需 Microsoft Word。</p>
<p>Aspose.Words API 支持大多数 Microsoft Word 格式，并且可以将文档页面呈现为多种图像格式。因此，您可以使用 DOC、DOCX、PDF、RTF、DOT、DOTX、DOTM、DOCM、FlatOPC、ODT、OTT、HTML、MHTML、MOBI、TXT、XPS、PS、TIFF、JPEG、PNG、BMP、 SVG、EMF、GIF、PCL、EPUB、XML、XAML 等。 你可以看到 <a href="https://docs.aspose.com/words/cpp/supported-document-formats/">支持格式的完整列表</a>.</p>
<h2 class="h2title">Functionality of Aspose.Words for C++</h2>
<p>Aspose.Words 是一个独立的 C++ 库。您无需安装其他应用程序即可使您的 C++ 代码正常工作。 这个 C++ API 依赖于 <a href="https://docs.aspose.com/words/cpp/aspose-words-document-object-model/">文档对象模型 (DOM)</a> 访问文档节点和元素。</p>
{{< /blocks/products/pf/i18n/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/i18n/carousel >}}

{{< blocks/products/pf/carousel-item h3="乍看上去" description="API 功能的通用视图。" >}}
<div class="diagram1 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ 文字处理库" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="该库完全支持在以下平台上开发的 C++ 应用程序 [系统要求](https://docs.aspose.com/words/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Word 文档操作 API" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Words for C++ 支持最流行的 [文字处理文件格式](https://docs.aspose.com/words/cpp/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ 文字编程 API" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/convert-a-document/">转换文档</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/rendering/">将文档渲染为固定布局格式</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/compare-documents/">比较文件</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/clone-a-document/">克隆文档</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/insert-and-append-documents/">加入文档：插入和追加</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/split-a-document/">拆分文件</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/find-and-replace/">查找和替换文本</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/protect-or-encrypt-a-document/">保护或加密文档</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-digital-signatures/">使用数字签名</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/mail-merge-and-reporting/">邮件合并和报告</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-watermark/">向文档添加水印</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-tables/">使用表格</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-fields/">插入、更新或删除字段</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/programming-with-documents/">格式化所有文档元素</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-comments/">处理评论和修订</a>
    </p>
   </div>
   <div>
   <p>
     请注意，该列表并不完整，您可以在 <a href="https://docs.aspose.com/words/cpp/developer-guide/">documentation</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     ...
     API 使 C++ 应用程序能够自动创建 Microsoft Word 文件以及打开和修改文件，包括使用在术语和功能上模仿 Microsoft Word 的直观文档对象模型进行格式化。 C++ 开发人员可以动态创建、修改、提取和替换所有元素，包括部分、段落、表格、书签、字段、表单字段、评论、图像、样式等。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     只需两行代码即可将文件从一种支持的格式转换为另一种格式。就是这么简单！
    </p>
...
doc->Save(outputPath);
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words for C++ 支持将多个文件合并和附加到一个文件中。此过程非常简单且可配置，提供了控制文件连接方式的方法。 C++ 文字处理库还允许在加入文档后重置页码。
    </p>
    <div class="codeblock" id="code">
     <h3>
      合并两个文件 – C++
...
dstDoc->Save(dir + u"output.doc);</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words for C++ 提供了使用单行代码保护和取消保护文档的功能。您可以以用户只能进行有限更改的方式设置保护，例如添加注释、进行修订或填写表格。
    </p>
    <div class="codeblock" id="code">
     <h3>
      保护和取消保护文件 - C++
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/words/cpp/" >}}
{{< blocks/products/pf/slr-element name="源代码" href="https://github.com/aspose-words/Aspose.Words-for-C" >}}
{{< blocks/products/pf/slr-element name="API 参考" href="https://apireference.aspose.com/words/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么选择 Aspose.Words for C++？" tabId="success-stories" >}}

...
<p>
 Aspose.Words for Android via Java 是一个文档处理 API，使您能够直接在 Android 应用程序中执行文档操作任务。 API 允许您轻松创建、操作、转换和呈现 Microsoft Word 文件。
</p>

<p>
 Aspose.Words for Android via Java 支持处理原生格式，如 DOC、DOCX、OOXML、TXT、RTF 以及许多其他常用格式，如 HTML、OpenDocument ODT、PDF、EPUB、XPS 和图像格式，如 JPEG、PNG 、SVG 和 EMF。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="API 的一些高级功能。" >}}
<div class="diagram1 d1-android">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Android 文字处理 API" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-android-java.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="API 适用于 Android OS 2.0 及更高版本。" >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Android Word 文档格式 API" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-android-java.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="diagram1 d2 d1-android">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Word 文档操作 API" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-android-java.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<li>Improve font substitution API.</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     能够以高精度快速可靠地转换不同文件是我们大多数客户选择 API 的原因。 Android Microsoft Word API 允许您将文件从任何支持的格式转换为任何其他支持的格式，例如将任何文档转换为高保真 SWF，生成的 SWF 包含文档页面和嵌入式查看器，允许在任何设备上查看文档。开发人员只需两行代码即可轻松转换格式。
    </p>
...
doc.save(SD_PATH + "output.html", SaveFormat.HTML);</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <p>
     该库为加载、查看、保存和转换 WordprocessingML 文件提供广泛支持。这种全面的实现是可能的，因为 API 设计时考虑了 Microsoft Word 文档的结构（众所周知，WordprocessingML 模仿了 Microsoft Word 文件的内部表示），因此我们可以轻松地将对这些实现的支持包含到我们的核心产品引擎中。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Android Word API 的 HTML 和 XHTML 导入对格式不正确的文档具有弹性。在导入过程中安全地忽略无效或无法识别的元素或属性，而转换为 HTML 和 XHTML 格式是可自定义的。可以指定许多参数，如文档属性、页眉和页脚、图像位置、缩放和分辨率、表单域导出选项等的导出。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Android 文档库允许开发人员创建、构建和修改文件 - 包括使用由 100 多个类组成的直观文档对象模型进行格式化。
    </p>
    <p>
     Android 开发人员可以通过编程方式创建、修改、提取和替换所有元素，包括部分、页眉、页脚、段落、列表、表格、文本、字段、超链接、书签和图像。 API 还允许为绘图对象指定详细的格式，包括形状、文本框、图像、OLE 对象和控件。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     您可以将 Android Microsoft Word API 用作功能齐全的报告解决方案。在 Microsoft Word 中设计报告，然后允许 API 使用来自各种来源的数据填充文档。
    </p>
    <p>
     API 允许开发人员在报告中使用标准的 Microsoft Word 邮件合并字段。此外，您可以使用 API 的邮件合并字段扩展语法在邮件合并操作期间执行更复杂的操作，例如插入图像或可重复区域。驱动您的报告和邮件合并的数据可以来自 ResultSet 对象、业务对象或完全自定义的数据源。
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/words/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么 Aspose.Words for Android 通过 Java？" tabId="success-stories" >}}

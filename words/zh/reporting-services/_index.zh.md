...
{{< blocks/products/pf/i18n/upper-banner h1="SSRS 扩展以提供 Word 格式的报告" h2="从 SQL Server Reporting Services 以 Word 文档格式导出 RDL 和 RDLC 报告。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-reporting-services.svg" pfName="Aspose.Words" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/words/reportingservices" >}}
...
<p>
 Aspose.Words for Reporting Services 是一个渲染扩展插件，使开发人员能够从 Microsoft SQL Server Reporting Services 中将 RDL 和 RDLC 报告导出为 DOC、DOCX、PDF、RTF、HTML、MHTML、ODT、TXT、XPS 和 WordprocessingML 文件。
</p>

<p>
 Aspose.Words for Reporting Services 完全支持 RDL 规范。您可以使用任何报表设计器重新设计现有报表或简单地将任何现有 RDL 报表导出为 Microsoft Word 文档，它将完全按照您的预期呈现 - 与 RDL 设计相同。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="Aspose.Words for Reporting Services 支持的 RDL 功能、技术、导出模式和导出格式的概述。" >}}
<div class="diagram1 d1-rs">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="RDL 到 Word 导出器" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-reporting-services.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="Aspose.Words for Reporting Services 支持 MS SQL Server Reporting Services 和 MS 报告查看器。" >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="SSRS 到字转换器" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-reporting-services.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Words for Reporting Services 允许输出到关键业务文字处理和元语言 [文件格式](https://docs.aspose.com/words/reportingservices/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-rs">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="文字渲染扩展" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-reporting-services.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words for Reporting Services 提供了多种导出格式。随意将您的报告导出为“原生”Microsoft Word 文档格式，例如 DOC、DOCX、RTF 和 WordML，或其他格式，例如 ODT、HTML、MHTML。 TXT、XPS 和 ePub。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words for Reporting Services 以与 Microsoft SQL Server Reporting Services 内置渲染器生成的原始报表设计相同的方式将报表导出到 Microsoft Word 文件。您可以在两种导出模式之间进行选择，或者通过更改单个配置设置来尝试两种布局类型，以找出最适合您需求的一种：
    </p>
    <ul class="unstyled">
     <li>
      流程布局
    ...
    <p>
     ...
     产生“可编辑” 由简单的段落、表格、部分组成的文档 - 这类似于办公室工作人员在 Microsoft Word 中创建文档。
    </p>
    <p>
     <strong>
      定位布局
     </strong>
     生成具有从 RDL 到 Microsoft Word 的最准确转换保真度的报告。报表中的表格和矩阵导出为 Microsoft Word 表格，而一些元素导出为定位的文本框，以保持尽可能接近原始设计的保真度。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words for Reporting Services 使用托管代码构建，无需在计算机上安装 Microsoft Word 即可使用 Word 文档格式。在支持的功能、安全性、稳定性、可扩展性、速度和价格方面，它是一个完美的 Microsoft Word 自动化替代方案。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/words/reportingservices/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么 Aspose.Words 用于Reporting Services？" tabId="success-stories" >}}

---
title: 在 JasperReports 和 JasperServer 中導出 Word 文件中的報告 
weight: 10660
url: /zh-TW/jasperreports/ 
description: 以 Word DOC Office Open XML OOXML DOCX RTF ODT HTML MHTML 和 TXT 格式從 Jasper Reports 和 JasperServer 導出報告
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="JasperReports 擴展以 Word 格式導出報告" h2="從 JasperReports 和 JasperServer 將報告導出為 Word 和 HTML 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-jasperreports.svg" pfName="Aspose.Words" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/words/jasperreports" >}}
...
<p>
 Aspose.Words for JasperReports 是市場上唯一可以將報告從 JasperReports 和 JasperServer 導出到 Microsoft Word 文檔 (DOC)、Office Open XML (OOXML、DOCX)、富文本格式 (RTF)、OpenDocument 文本 ( ODT)、網頁 (HTML) 和純文本 (TXT) 格式，無需使用 Microsoft Word。所有具有最高精確度的報告功能都可以轉換為 Microsoft Word 文件。
</p>
...
<div class="diagram1 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="JasperReports 到單詞導出器" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="Aspose.Words for JasperReports 支持 J2SE、JasperReports 和 JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="JasperReports 到 DOC 轉換器" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Words for JasperReports 支持最流行的文字處理、文本和網頁 [文件格式](https://docs.aspose.com/words/jasperreports/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="JasperReports Word 導出器" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words for JasperReports 允許您從 JasperReports 和 JasperServer 將報告導出為 DOC 和 DOCX 文檔。與 RTF 相比，這些格式具有許多優點，例如文件更小、內容格式增加以及最終用戶易於編輯。
    </p>
    <p>
     除了 Microsoft Word 格式，Aspose.Words for JasperReports 還提供以 RTF、ODT、HTML 和 TXT 格式導出報告的功能。
    </p>
   </div>
   <!--
...
<h2 class="h2title">Easy & 輕量級部署</h2>
...
-->
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words for JasperReports 將報告導出到 Microsoft Word 文檔中，結果看起來與內置 JasperReports 報告設計器生成的原始報告設計相同。所有報告功能都轉換為最高精度，以使 Microsoft Word 文檔看起來盡可能接近原始設計。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words for JasperReports 導出流佈局文檔。這意味著文件包括 "
     <strong>
      普通的
     </strong>
     " 如有必要，易於在 Microsoft Word 中進一步編輯的段落、表格和圖像。 內置的 JasperReports RTF 導出器生成由定位文本框架組成的文檔，這使得最終用戶的編輯任務變得不那麼直觀.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words for JasperReports 使用託管代碼構建，無需在機器上安裝 Microsoft Word 即可處理 Word 文檔格式。 在支持的功能、安全性、穩定性、可擴展性、速度和價格方面，它是一個完美的 Microsoft Word 自動化替代方案。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/words/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼為 JasperReports 使用 Aspose.Words？" tabId="success-stories" >}}

...
<p><strong>Aspose.Words for C++</strong> 是一種高級 Word 文檔處理 API，用於執行廣泛的處理任務。 Words 的 API 直接在您自己的 C++ 應用程序中提供文檔格式化、操作、郵件合併、水印和更多功能，而無需 Microsoft Word。</p>
<p>Aspose.Words API 支持大多數 Microsoft Word 格式，並且可以將文檔頁面呈現為多種圖像格式。因此，您可以使用 DOC、DOCX、PDF、RTF、DOT、DOTX、DOTM、DOCM、FlatOPC、ODT、OTT、HTML、MHTML、MOBI、TXT、XPS、PS、TIFF、JPEG、PNG、BMP、 SVG、EMF、GIF、PCL、EPUB、XML、XAML 等。 你可以看到 <a href="https://docs.aspose.com/words/cpp/supported-document-formats/">支持格式的完整列表</a>.</p>
<h2 class="h2title">Functionality of Aspose.Words for C++</h2>
<p>Aspose.Words 是一個獨立的 C++ 庫。您無需安裝其他應用程序即可使您的 C++ 代碼正常工作。 這個 C++ API 依賴於 <a href="https://docs.aspose.com/words/cpp/aspose-words-document-object-model/">文檔對像模型 (DOM)</a> 訪問文檔節點和元素。</p>
{{< /blocks/products/pf/i18n/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/i18n/carousel >}}

{{< blocks/products/pf/carousel-item h3="乍看上去" description="API 功能的通用視圖。" >}}
<div class="diagram1 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ 文字處理庫" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="該庫完全支持在以下平台上開發的 C++ 應用程序 [系統要求](https://docs.aspose.com/words/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Word 文檔操作 API" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Words for C++ 支持最流行的 [文字處理文件格式](https://docs.aspose.com/words/cpp/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ 文字編程 API" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/convert-a-document/">轉換文檔</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/rendering/">將文檔渲染為固定佈局格式</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/compare-documents/">比較文件</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/clone-a-document/">克隆文檔</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/insert-and-append-documents/">加入文檔：插入和追加</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/find-and-replace/">查找和替換文本</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/protect-or-encrypt-a-document/">保護或加密文檔</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-digital-signatures/">使用數字簽名</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/mail-merge-and-reporting/">郵件合併和報告</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-watermark/">向文檔添加水印</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-fields/">插入、更新或刪除字段</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/programming-with-documents/">格式化所有文檔元素</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-comments/">處理評論和修訂</a>
    </p>
   </div>
   <div>
   <p>
     請注意，該列表並不完整，您可以在 <a href="https://docs.aspose.com/words/cpp/developer-guide/">documentation</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     ...
     API 使 C++ 應用程序能夠自動創建 Microsoft Word 文件以及打開和修改文件，包括使用在術語和功能上模仿 Microsoft Word 的直觀文檔對像模型進行格式化。 C++ 開發人員可以動態創建、修改、提取和替換所有元素，包括部分、段落、表格、書籤、字段、表單字段、評論、圖像、樣式等。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     只需兩行代碼即可將文件從一種支持的格式轉換為另一種格式。就是這麼簡單！
    </p>
...
doc->Save(outputPath);
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words for C++ 支持將多個文件合併和附加到一個文件中。此過程非常簡單且可配置，提供了控製文件連接方式的方法。 C++ 文字處理庫還允許在加入文檔後重置頁碼。
    </p>
    <div class="codeblock" id="code">
     <h3>
      合併兩個文件 – C++
...
dstDoc->Save(dir + u"output.doc);</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words for C++ 提供了使用單行代碼保護和取消保護文檔的功能。您可以以用戶只能進行有限更改的方式設置保護，例如添加註釋、進行修訂或填寫表格。
    </p>
    <div class="codeblock" id="code">
     <h3>
      保護和取消保護文件 - C++
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/words/cpp/" >}}
{{< blocks/products/pf/slr-element name="源代碼" href="https://github.com/aspose-words/Aspose.Words-for-C" >}}
{{< blocks/products/pf/slr-element name="API 參考" href="https://apireference.aspose.com/words/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼選擇 Aspose.Words for C++？" tabId="success-stories" >}}

...
{{< blocks/products/pf/i18n/upper-banner h1="Расширение JasperReports для экспорта отчетов в формате Word" h2="Экспортируйте отчеты в форматы Word и HTML из JasperReports и JasperServer." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-jasperreports.svg" pfName="Aspose.Words" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/words/jasperreports" >}}
...
<p>
 Aspose.Words for JasperReports — единственное решение на рынке, позволяющее экспортировать отчеты из JasperReports и JasperServer в документы Microsoft Word (DOC), Office Open XML (OOXML, DOCX), Rich Text Format (RTF), OpenDocument Text ( ODT), веб-страницы (HTML) и обычный текст (TXT) без использования Microsoft Word. Все функции отчета с высочайшей степенью точности могут быть преобразованы в файл Microsoft Word.
</p>
...
{{< blocks/products/pf/carousel-item h3="С одного взгляда" description="Возможности Aspose.Words для JasperReports." >}}
<div class="diagram1 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="JasperReports для экспортера Words" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Независимость от платформы" description="Aspose.Words для JasperReports поддерживает J2SE, JasperReports и JasperServer.." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
  ...
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 3.0 или выше
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
    </i>
    JasperServer 3.7.1 или выше
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports Server 7.1.0 или выше
   </header>
  </div>
  <!--/right-->
 </div>
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Конвертер JasperReports в DOC" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Поддерживаемые форматы файлов" description="Aspose.Words для JasperReports поддерживает самые популярные программы обработки текстов, текстовых и веб-приложений. [форматы файлов](https://docs.aspose.com/words/jasperreports/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Экспортер JasperReports для Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     Поддержка самых популярных форматов Microsoft Word
    </h2>
    <p>
     Aspose.Words for JasperReports позволяет экспортировать отчеты в виде документов DOC и DOCX из JasperReports и JasperServer. По сравнению с RTF эти форматы имеют ряд преимуществ, таких как меньший размер файла, улучшенное форматирование контента и простота редактирования конечными пользователями.
    </p>
    <p>
     Помимо форматов Microsoft Word, Aspose.Words for JasperReports предлагает возможность экспорта отчетов в форматы RTF, ODT, HTML и TXT.
    </p>
   </div>
   <!--
...
<h2 class="h2title">Easy & Легкое развертывание</h2>
...
-->
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words for JasperReports экспортирует отчеты в документы Microsoft Word таким образом, чтобы результат был идентичен исходному дизайну отчета, созданному встроенным дизайнером отчетов JasperReports. Все функции отчета преобразуются с высочайшей степенью точности, чтобы документы Microsoft Word выглядели как можно ближе к исходному дизайну.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words for JasperReports экспортирует документы потокового макета. Это означает, что документы состоят из "
     <strong>
      обычный
     </strong>
     " абзацы, таблицы и изображения, которые при необходимости легко редактировать в Microsoft Word. Встроенный экспортер RTF JasperReports создает документы, состоящие из позиционированных текстовых фреймов, что делает редактирование конечными пользователями менее интуитивно понятной задачей..
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/words/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Words для JasperReports?" tabId="success-stories" >}}

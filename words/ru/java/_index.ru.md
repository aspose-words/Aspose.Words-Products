...
{{< blocks/products/pf/i18n/upper-banner h1="Java API для обработки файлов Word" h2="Разрабатывайте приложения с возможностью создавать, обрабатывать, отображать и преобразовывать документы Word в различные форматы на Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-java.svg" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/words/java" >}}
...
<p>
Aspose.Words for Java — это многофункциональный API-интерфейс обработки документов для создания, изменения, преобразования, рендеринга и печати файлов во всех форматах, поддерживаемых Microsoft Word и т. д. Это не зависит от Microsoft Word или других сторонних приложений. Однако Aspose.Words для Java предоставляет функции, поддерживаемые Word. – <a href="https://docs.aspose.com/words/java/compare-documents/">сравнить документы</a>, <a href="https://docs.aspose.com/words/java/find-and-replace/">найти и заменить</a> text, <a href="https://docs.aspose.com/words/java/split-a-document/">разделить документ</a> на части, <a href="https://docs.aspose.com/words/java/mail-merge-and-reporting/">слияние почты</a> поля, <a href="https://docs.aspose.com/words/java/rendering/">отображать страницы</a>, <a href="https://docs.aspose.com/words/java/programming-with-documents/">форматировать все элементы документа</a> и так далее. Вы можете увидеть полный список возможностей Aspose.Words <a href="https://docs.aspose.com/words/java/">в нашей документации</a>.
</p>

<p>
Aspose.Words API поддерживает все популярные форматы загрузки и сохранения. Вы можете сохранять или преобразовывать документы Word в форматы с фиксированным макетом — PDF или XML, а также преобразовывать файлы Word в популярные графические или мультимедийные форматы — JPEG, SVG, GIF и другие. Проверьте <a href="https://docs.aspose.com/words/java/supported-document-formats/">полный список поддерживаемых форматов</a>.
</p>
...
{{< blocks/products/pf/carousel-item h3="At a Glance" description="Некоторые из расширенных возможностей API." >}}
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API Java для документов Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Независимость от платформы" description="API можно использовать в любых приложениях на основе Java, разработанных для платформ Windows Unix/Linux и Mac." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API обработки текстов Java" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Поддерживаемые форматы файлов" description="Aspose.Words для Java поддерживает самые популярные [Форматы текстовых документов](https://docs.aspose.com/words/java/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API-интерфейсы управления документами Word для Java" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <a href="https://products.aspose.app/words/unlock">
     ...
     <p class="description">
      Разблокируйте защищенные документы Word и OpenOffice<br>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/convert-a-document/">Преобразовать документ</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/rendering/">Рендеринг документа в форматы с фиксированным макетом</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/compare-documents/">Сравнить документы</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/clone-a-document/">Клонировать документ</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/insert-and-append-documents/">Соединение документов: вставка и добавление</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/split-a-document/">Разделить файлы</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/find-and-replace/">Найти и заменить текст</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/protect-or-encrypt-a-document/">Защитить или зашифровать документ</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/working-with-digital-signatures/">Работа с цифровыми подписями</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/mail-merge-and-reporting/">Слияние почты и отчетность</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/working-with-watermark/">Добавить водяной знак в документ</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/working-with-tables/">Работа с таблицами</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/linq-reporting-engine/">Модуль отчетов LINQ</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/programming-with-documents/">Форматировать все элементы документа</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/working-with-comments/">Работа с комментариями и исправлениями</a>
    </p>
   </div>
   <div>
   <p>
     Обратите внимание, что список не является полным, и вы можете найти больше функций и описаний в <a href="https://docs.aspose.com/words/java/developer-guide/">документация</a>.
   </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="java">// Загрузить файл DOC для конвертации
...
wpd.save(dir + "output.docx", SaveFormat.DOCX);</code></pre>
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="java">// Загружаем HTML-файл для конвертации
...
wpd.save(dir + "output.docx", SaveFormat.DOCX);</code></pre>
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="java">// Загружаем файл RTF для конвертации
...
wpd.save(dir + "output.pdf", SaveFormat.PDF);</code></pre>
    ...
    <p>
     Подробнее см. <a href="https://products.aspose.com/words/java/conversion/">страница конвертации</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <ul>
    <li><a href="https://docs.aspose.com/words/java/rendering/">отображать страницы или полные документы</a> </li>
    <li><a href="https://docs.aspose.com/words/java/saving-a-document-as-a-multipage-tiff/">конвертировать страницы документа в изображения</a> для предварительного просмотра</li>
    <li>преобразовать документ <a href="https://docs.aspose.com/words/java/specify-rendering-options-when-converting-to-pdf/">в PDF</a> или <a href="https://docs.aspose.com/words/java/learn-features-of-conversion-to-pdf-a/">PDF/A</a></li>
    <li><a href="https://docs.aspose.com/words/java/using-truetype-fonts/">управлять шрифтами и заменами шрифтов</a></li>
    <li><a href="https://docs.aspose.com/words/java/print-a-document-programmatically-or-using-dialogs/">распечатать документc программно или с помощью диалогов</a></li>
    <li>and so on</li>
    </ul>
    </p>
   </div>
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="java">// Загружаем исходный и конечный файлы
...
<p class="first">
 С помощью Aspose.Words мы повысили эффективность организационных процессов, поскольку сократили время, затрачиваемое на техническую поддержку. Теперь мы можем сказать, что мы сосредоточены только на нашем основном бизнесе.
 <em>
...
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 Работа с Aspose.Words оказалась очень приятным и простым в реализации решением. Одной из лучших функций является быстрое создание больших документов.
 <em>
  Том Дэниелс | Издательство Pill Creek, Великобритания
 </em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/testimonials-quote >}}
<p class="third">
 Aspose.Words сэкономил нам много времени, усилий и денег. Это дало нашим клиентам хорошую и надежную функциональность импорта/экспорта, чтобы они могли открывать свои старые документы в WriteOnline.
 <em>
  Эндрю Берт | Крик Софтвер Лтд, США
 </em>
</p>
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/words/java/" >}}
...
{{< blocks/products/pf/slr-element name="Примечания к выпуску" href="https://docs.aspose.com/words/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/java/working-with-watermark/">เพิ่มลายน้ำให้กับเอกสาร</a>
    </p>
   </div>
   <div class="col-lg-4">

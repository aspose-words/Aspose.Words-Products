...
{{< blocks/products/pf/i18n/upper-banner h1="Rozšíření JasperReports pro export přehledů ve formátu Word" h2="Export sestav do formátu Word a HTML z JasperReports a JasperServer." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-jasperreports.svg" pfName="Aspose.Words" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/words/jasperreports" >}}
...
<p>
 Aspose.Words for JasperReports je jediné řešení na trhu, které umožňuje exportovat reporty z JasperReports a JasperServer do dokumentu Microsoft Word (DOC), Office Open XML (OOXML, DOCX), Rich Text Format (RTF), OpenDocument Text ( ODT), formáty webové stránky (HTML) a prostého textu (TXT) bez použití aplikace Microsoft Word. Všechny funkce sestavy s nejvyšším stupněm přesnosti lze převést do souboru Microsoft Word.
</p>
...
{{< blocks/products/pf/carousel-item h3="Na první pohled" description="Funkce Aspose.Words pro JasperReports." >}}
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Aspose.Words for JasperReports podporuje J2SE, JasperReports a JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
  ...
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 3.0 nebo vyšší
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
    </i>
    JasperServer 3.7.1 nebo vyšší
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports Server 7.1.0 nebo vyšší
   </header>
  </div>
  <!--/right-->
 </div>
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.Words for JasperReports podporuje nejpopulárnější zpracování textu, textu a webu [formáty souborů](https://docs.aspose.com/words/jasperreports/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="JasperReports Exporter pro Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     Podpora pro nejoblíbenější formáty Microsoft Word
    </h2>
    <p>
     Aspose.Words for JasperReports umožňuje exportovat zprávy jako dokumenty DOC a DOCX z JasperReports a JasperServer. Ve srovnání s RTF nabízejí tyto formáty řadu výhod, jako je menší velikost souboru, větší formátování obsahu a snadná editace koncovými uživateli.
    </p>
    <p>
     Kromě formátů Microsoft Word nabízí Aspose.Words for JasperReports možnost exportovat sestavy ve formátech RTF, ODT, HTML a TXT.
    </p>
   </div>
   <!--
...
<h2 class="h2title">Easy & Lehké nasazení</h2>
...
-->
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words for JasperReports exportuje sestavy do dokumentů Microsoft Word takovým způsobem, že výsledek vypadá identicky s původním návrhem sestavy vytvořeným vestavěným návrhářem sestav JasperReports. Všechny funkce sestav jsou převedeny na nejvyšší stupeň přesnosti, aby dokumenty Microsoft Word vypadaly co nejblíže původnímu návrhu.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words pro JasperReports exportuje dokumenty s rozložením toku. To znamená, že dokumenty se skládají z "
     <strong>
      normální
     </strong>
     " odstavce, tabulky a obrázky, které lze v případě potřeby snadno dále upravovat v aplikaci Microsoft Word. Vestavěný exportér JasperReports RTF vytváří dokumenty skládající se z umístěných textových rámečků, takže úpravy pro koncové uživatele jsou méně intuitivní..
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words for JasperReports je vytvořen pomocí spravovaného kódu, který pro práci s formáty dokumentů aplikace Word nikdy nevyžaduje instalaci aplikace Microsoft Word do počítače. Jedná se o dokonalou alternativu automatizace Microsoft Word z hlediska podporovaných funkcí, zabezpečení, stability, škálovatelnosti, rychlosti a ceny.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/words/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.Words pro JasperReports?" tabId="success-stories" >}}

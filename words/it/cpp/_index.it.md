---
title: API Word C++ | Analisi e conversione della creazione di documenti 
weight: 8250
url: /it/cpp/ 
description: Libreria di elaborazione di documenti Word C++ per generare, modificare, convertire e renderizzare un documento utilizzando C++. Leggi, scrivi e analizza dinamicamente formati Word come DOC, DOCX o altri formati come PDF, RTF, ODT, TXT, MOBI, HTML, JPG, PNG.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API di elaborazione di documenti di Word C++" h2="Genera, modifica, converti ed esegui il rendering di documenti Microsoft Word nell'applicazione C++ senza richiedere Microsoft Word." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-cpp.svg" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/words/cpp" >}}
...
<p><strong>Aspose.Words for C++</strong> è un'API avanzata di elaborazione di documenti di Word per eseguire un'ampia gamma di attività di elaborazione. L'API di Words fornisce funzionalità di formattazione, manipolazione, stampa unione, watermark e molto altro dei documenti direttamente all'interno delle tue applicazioni C++ senza richiedere Microsoft Word.</p>
<p>L'API Aspose.Words supporta la maggior parte dei formati di Microsoft Word e può eseguire il rendering delle pagine del documento in diversi formati di immagine. Pertanto, puoi lavorare con documenti in DOC, DOCX, PDF, RTF, DOT, DOTX, DOTM, DOCM, FlatOPC, ODT, OTT, HTML, MHTML, MOBI, TXT, XPS, PS, TIFF, JPEG, PNG, BMP, SVG, EMF, GIF, PCL, EPUB, XML, XAML e altro ancora. Puoi vedere <a href="https://docs.aspose.com/words/cpp/supported-document-formats/">l'elenco completo dei formati supportati</a>.</p>
<h2 class="h2title">Functionality of Aspose.Words for C++</h2>
<p>Aspose.Words è una libreria C++ autonoma. Non è necessario installare applicazioni aggiuntive per far funzionare il codice C++. Questa API C++ si basa su <a href="https://docs.aspose.com/words/cpp/aspose-words-document-object-model/">Document Object Model (DOM)</a> per accedere a nodi ed elementi del documento.</p>
{{< /blocks/products/pf/i18n/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/i18n/carousel >}}

{{< blocks/products/pf/carousel-item h3="A prima vista" description="Una vista generica delle capacità dell'API." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Note a piè di pagina, note di chiusura e commenti
    </li>
   </ul>
  </div>
  <!--/right-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Libreria di elaborazione testi C++" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="La libreria supporta completamente le applicazioni C++ sviluppate sulle seguenti piattaforme con [requisiti di sistema](https://docs.aspose.com/words/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API di manipolazione dei documenti di Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="Aspose.Words per C++ supporta i più diffusi [Formati di file di elaborazione testi](https://docs.aspose.com/words/cpp/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API di programmazione Word C++" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/convert-a-document/">Converti un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/rendering/">Rendering di un documento in formati a layout fisso</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/compare-documents/">Confronta documenti</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/clone-a-document/">Clona un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/insert-and-append-documents/">Unisci documenti: inserisci e aggiungi</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/split-a-document/">Dividi file</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/find-and-replace/">Trova e sostituisci testo</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/protect-or-encrypt-a-document/">Proteggi o crittografa un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-digital-signatures/">Lavora con le firme digitali</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/mail-merge-and-reporting/">Stampa unione e reportistica</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-watermark/">Aggiungi filigrana a un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-tables/">Lavora con le tabelle</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-fields/">Inserisci, aggiorna o rimuovi campi</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/programming-with-documents/">Formatta tutti gli elementi del documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-comments/">Lavora con commenti e revisioni</a>
    </p>
   </div>
   <div>
   <p>
     Si prega di notare che l'elenco non è completo e si possono trovare ulteriori caratteristiche e descrizioni nel <a href="https://docs.aspose.com/words/cpp/developer-guide/">documentation</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Documentazione" href="https://docs.aspose.com/words/cpp/" >}}
{{< blocks/products/pf/slr-element name="Codice sorgente" href="https://github.com/aspose-words/Aspose.Words-for-C" >}}
{{< blocks/products/pf/slr-element name="Riferimenti API" href="https://apireference.aspose.com/words/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.Words per C++?" tabId="success-stories" >}}

---
title: API Python per l'elaborazione di documenti Word – Aspose 
weight: 2200
url: /it/python-net/
description: Libreria Python per lavorare con i file di Microsoft Word. Crea modifica converti DOCX DOC RTF PDF EPUB WordML ODT HTML Testo e molti altri formati.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API Python per elaborare documenti Word" h2="Crea, modifica, renderizza e converti file di Word in più formati usando Python. Genera anche report e visualizza i tuoi dati. Tutto questo senza l'utilizzo di software esterni." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-python.svg" pfName="Aspose.Words" subTitlepfName="for Python" downloadUrl="https://downloads.aspose.com/words/python" >}}
...
<p><strong>Aspose.Words for Python via .NET</strong> è un pacchetto, progettato per leggere e manipolare documenti di vario tipo, con un focus primario su documenti Microsoft Word (DOC, DOCX, ODT), PDF e Web (HTML, Markdown). La nostra libreria contiene più di 100 classi Python per gestire operazioni di basso livello dietro l'elaborazione dei documenti e la formattazione dei dati. Pertanto, Aspose.Words offre agli sviluppatori Python un'opportunità unica per implementare l'automazione dei documenti basata su script.</p>
<p>Con l'avvento di potenti hardware per computer negli ultimi decenni, Python è diventato un linguaggio di programmazione ampiamente utilizzato nello sviluppo web (Django, Flask, framework Pyramid), attività scientifiche e analisi dei dati. L'utilità di Python deriva da un vasto ecosistema di pacchetti di terze parti. Fornito con un gran numero di librerie a sviluppo progressivo, Python è considerato la scelta migliore per lo sviluppo rapido di software.</p>
<p>Il team di Aspose.Words ha deciso di stare al passo con le ultime tendenze di programmazione e di fornire alla comunità Python un software professionale per elaborare DOC, DOCX, PDF, RTF, DOT, DOTX, DOTM, DOCM, FlatOPC, ODT, OTT, HTML, MHTML, MOBI, TXT, XPS, PS, TIFF, JPEG, PNG, BMP, SVG, EMF, GIF, PCL, EPUB, XML, XAML e altri formati di file. Puoi vedere <a href="https://docs.aspose.com/words/python-net/supported-document-formats/">l'elenco completo dei formati supportati</a>.</p>
<p><i>Nota:</i> secondo TIOBE Programming Index, che riflette la popolarità dei linguaggi di programmazione, Python oggi è un linguaggio di programmazione numero uno.</p>
<h2 class="h2title">Funzionalità di Aspose.Words per Python tramite .NET</h2>
<p>Aspose.Words è una libreria Python autonoma. Non è necessario installare alcuna suite per ufficio per far funzionare il codice Python. Questa API Python si basa su <a href="https://docs.aspose.com/words/python-net/aspose-words-document-object-model/">Modello a oggetti del documento (DOM)</a> per accedere a nodi ed elementi del documento.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<div class="diagram1 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API di elaborazione testi Python" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-python.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="Python Word API supporta tutte le principali piattaforme, incluse le seguenti." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API di manipolazione dei documenti di Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-python.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="Aspose.Words per Python via.NET supporta il popolare [Formati di file di elaborazione testi](https://docs.aspose.com/words/python-net/supported-document-formats/)  elencate di seguito." >}}
...
<li>MOBI</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API di programmazione Python Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-python.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/convert-a-document/">Converti un documento</a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/rendering/">Rendering di un documento in formati a layout fisso</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/compare-documents/">Confronta documenti</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/clone-a-document/">Clona un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/insert-and-append-documents/">Unisci documenti: inserisci e aggiungi</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/split-a-document/">Dividi file</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/find-and-replace/">Trova e sostituisci testo</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/protect-or-encrypt-a-document/">Proteggi o crittografa un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/working-with-digital-signatures/">Lavora con le firme digitali</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/mail-merge-and-reporting/">Mail Merge and Segnalazione</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/working-with-watermark/">Aggiungi filigrana a un documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/working-with-tables/">Lavora con le tabelle</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/linq-reporting-engine/">LINQ Segnalazione Engine</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/programming-with-documents/">Formatta tutti gli elementi del documento</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/python-net/working-with-comments/">Lavora con commenti e revisioni</a>
    </p>
   </div>
   <div>
   <p>
     Si prega di notare che l'elenco non è completo e si possono trovare ulteriori caratteristiche e descrizioni nel <a href="https://docs.aspose.com/words/python-net/developer-guide/">documentazione</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <ul>
	  ...
	  <li>Nel caso in cui scrivi codice Python su Linux, dai un'occhiata a <a href="https://docs.aspose.com/words/python-net/system-requirements/">requisiti aggiuntivi per Linux</a></li>
    </ul>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>Usa <strong>pip</strong> per installare la nostra libreria Python per l'elaborazione di documenti Word dal file <a href="https://pypi.org/project/aspose-words/">Repository PyPI</a>:
...
doc.save("Output.html")
   ...
   <p>
     Vedere <a href="https://docs.aspose.com/words/python-net/convert-a-document/">la sezione Conversione</a> per ulteriori dettagli.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Documentazione" href="https://docs.aspose.com/words/python-net/" >}}
{{< blocks/products/pf/slr-element name="Codice sorgente" href="https://github.com/aspose-words/Aspose.Words-for-Python-via-.NET" >}}
{{< blocks/products/pf/slr-element name="Riferimenti API" href="https://docs.aspose.com/words/python-net/" >}}
...
{{< blocks/products/pf/slr-element name="Note di rilascio" href="https://docs.aspose.com/words/python-net/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.Words per Python tramite.NET?" tabId="success-stories" >}}

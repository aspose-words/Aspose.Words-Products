---
title: Exportera RDL-rapporter till Word-format i SQL Server - Aspose 
weight: 3900
url: /sv/reporting-services/ 
description: SQL Server Reporting Services renderingstillägg - Exportera Word DOC DOCX PDF RTF HTML MHTML ODT TXT XPS och WordprocessingML dokumentformat
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="SSRS-tillägg för att leverera rapporter i Word-format" h2="Exportera RDL- och RDLC-rapporter i Word-dokumentformat från SQL Server Reporting Services." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-reporting-services.svg" pfName="Aspose.Words" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/words/reportingservices" >}}
...
{{< blocks/products/pf/carousel-item h3="En överblick" description="En översikt över RDL-funktioner, teknologier, exportlägen och exportformat som Aspose.Words for Reporting Services stöder." >}}
<div class="diagram1 d1-rs">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="RDL till Word Exporter" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-reporting-services.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Aspose.Words for Reporting Services stöder MS SQL Server Reporting Services och MS Rapportvisare." >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="SSRS till Word Converter" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-reporting-services.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.Words for Reporting Services tillåter utdata till affärskritisk ordbehandling och metaspråk [filformat](https://docs.aspose.com/words/reportingservices/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-rs">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Ordåtergivningsförlängning" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-reporting-services.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     ...
     producerar "redigerbar" dokument som består av enkla stycken, tabeller, avsnitt - detta liknar i jämförelse med en kontorsarbetare som skapar dokumentet i Microsoft Word.
    </p>
    <p>
     <strong>
      Positionerad layout
     </strong>
     producerar rapporter med den mest exakta konverteringsfideliteten från RDL till Microsoft Word. Tabeller och matriser från rapporter exporteras som Microsoft Word-tabeller, medan vissa element exporteras som placerade textrutor för att hålla troheten så nära den ursprungliga designen som möjligt.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Words för rapporteringstjänster?" tabId="success-stories" >}}

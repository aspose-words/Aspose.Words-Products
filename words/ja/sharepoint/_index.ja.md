...
{{< blocks/products/pf/carousel-item h3="サポートされているファイル形式" description="Aspose.Words for SharePointは、多くの人気のあるものをサポートしています 【ワープロファイル形式】(https://docs.aspose.com/words/sharepoint/supported-document-formats/)." >}}

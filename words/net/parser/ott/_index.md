...
weight: 6840
url: /net/parser/ott/ 
description: Try our On-Premise document parser APIs to extract text and images from OTT file on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Parse OTT Formats in C#" h2="Native and high performance OTT document parsing using server-side Aspose.Words for .NET APIs, without the use of any software like Microsoft or Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Words" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="OTT" >}}
...
//Extract Content Between Different Types of Nodes
    string fileName = "TestFile.ott";
    Document ott = new Document(dataDir + fileName);
    
    Paragraph startPara = (Paragraph)ott.LastSection.GetChild(NodeType.Paragraph, 2, true);
    Table endTable = (Table)ott.LastSection.GetChild(NodeType.Table, 0, true);

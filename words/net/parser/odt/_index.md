...
weight: 9010
url: /net/parser/odt/ 
description: Try our On-Premise document parser APIs to extract text and images from ODT file on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Parse ODT Formats in C#" h2="Native and high performance ODT document parsing using server-side Aspose.Words for .NET APIs, without the use of any software like Microsoft or Adobe PDF." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Words" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODT" >}}
...
//Extract Content Between Different Types of Nodes
    ...
    Document odt = new Document(dataDir + fileName);
    
    Paragraph startPara = (Paragraph)odt.LastSection.GetChild(NodeType.Paragraph, 2, true);
    Table endTable = (Table)odt.LastSection.GetChild(NodeType.Table, 0, true);

---
title: Merge FlatOpcTemplate Files via .NET 
url: /net/merger/flatopctemplate/ 
description: C# sample code to combine FlatOpcTemplate documents on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge FlatOpcTemplate Formats in C#" h2="Native and high performance FlatOpcTemplate document merger using server-side .NET APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="FlatOpcTemplate" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge FlatOpcTemplate File Using C#" %}}

 In order to merge FlatOpcTemplate file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Merging FlatOpcTemplate Files in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Developers can easily merge FLATOPCTEMPLATE documents by following the steps.

{{% /blocks/products/pf/agp/text %}}

+  Load all the FlatOpcTemplate files with full path.
+  Make one document as the base file
+  Call the relevant method for concatenating and merging files one by one.
+  Call the Save() method and pass the file name (full path) and format (FlatOpcTemplate) as a parameter.
...
{{% blocks/products/pf/agp/code-block title="Merge FlatOpcTemplate Files - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 .NET Words API can be used to load, view and convert Microsoft Word and OpenDocument Formats like DOC, DOCX, ODT to PDF, XPS, HTML and various other formats. You can also create new documents from scratch and save them in the supported formats. It is a standalone API that is suitable for server side and backend systems where high performance is required. It does not depend on any software like Microsoft or OpenOffice. ‎
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online FlatOpcTemplate Merger Live Demos" sectionDescription="Merge FlatOpcTemplate documents right now by visiting our [Live Demos website](https://products.aspose.app/words/merger). The live demo has the following benefits" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Just upload your FlatOpcTemplate files." >}}

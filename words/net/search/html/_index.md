...
weight: 5660
url: /net/search/html/ 
description: Try our On-Premise document APIs to search words with pattern in HTML file on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---
...
```cs
Document html = new Document("../../data/document.html");
...
doc.Save("replacedDocument.html");  

...
{{% blocks/products/pf/agp/content h2="How to Edit RTF File Using C#" %}}

 In order to edit RTF file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Editing RTF Files in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Developers can easily edit RTF documents by following the steps.

{{% /blocks/products/pf/agp/text %}}

+  Design and Develop your editor.
+  Or use Aspose Editor by accessing its demo app using advanced WYSIWYG editor
+  Upload RTF files to edit.
...
{{% blocks/products/pf/agp/code-block title="Edit RTF Files - C#" offSpacer="" %}}

```cs
//while loading convert content into html data, Edit it and save using below code
public Response UpdateContents(string rtfFileName, string htmldata, string outputType){
outputType = outputType.ToLower();
var foldername = Guid.NewGuid().ToString();
var fn = Path.GetFileNameWithoutExtension(rtfFileName) + outputType;

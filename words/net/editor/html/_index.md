...
weight: 1420
url: /net/editor/html/ 
description: C# sample code to edit Microsoft Word HTML file using server side .NET library.
---
...
{{% blocks/products/pf/agp/content h2="How to Edit HTML File Using C#" %}}
 ...
 In order to edit HTML file, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily edit HTML documents by following the steps.

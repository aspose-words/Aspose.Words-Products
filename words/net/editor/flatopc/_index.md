...
description: C# sample code to edit FlatOpc document on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily edit FLATOPC documents by following the steps.

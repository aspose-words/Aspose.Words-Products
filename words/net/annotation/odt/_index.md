...
description: Try our On-Premise document annotation APIs to delete ODT format annotations on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add, Edit & Delete Annotation from ODT via C#" h2="Build your own .NET apps to manipulate comments & authors in document files using server-side APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="ODT" pfName="Aspose.Words" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Annotate ODT File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Manipulate Annotation of ODT via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Delete Annotations from ODT - C#" offSpacer="" %}}

```cs
// load the ODT with an instance of Document class

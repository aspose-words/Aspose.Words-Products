...
description: Delete OTT format annotations on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add, Edit & Delete Annotation from OTT via C#" h2="Build your own .NET apps to manipulate comments & authors in document files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTT" pfName="Aspose.Words" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Annotate OTT File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Manipulate Annotation of OTT via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Delete Annotations from OTT - C#" offSpacer="" %}}

```cs
// load the OTT with an instance of Document class

...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Generating MS Word DOCM file dynamically from templates within running application is easy. In order to create Microsoft Word DOCM documents from scratch or just by populating the predefined Word templates without requiring MS Office, we’ll use

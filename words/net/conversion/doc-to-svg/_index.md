---
title: Convert DOC to SVG via .NET 
weight: 8100
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words makes it easy for the developers to load & convert DOC files to SVG in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOC to SVG" sectionDescription="Check our live demos for [DOC to SVG conversion](https://products.aspose.app/words/conversion/doc-to-svg) with following benefits." >}}

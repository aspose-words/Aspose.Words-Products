...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words makes it easy for the developers to load & convert MOBI files to XPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MOBI to XPS C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MOBI to XPS" sectionDescription="Check our live demos for [MOBI to XPS conversion](https://products.aspose.app/words/conversion/mobi-to-xps) with following benefits." >}}

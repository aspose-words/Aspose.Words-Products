---
title: Convert WORDML to OPENXPS via C# 
url: /net/conversion/wordml-to-openxps/ 
description: Sample code for WORDML to OPENXPS C# conversion. Use API for Batch WORDML Files to OPENXPS conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert WORDML to OPENXPS via C#" h2="Native and high performance WORDML to OPENXPS conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OPENXPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OPENXPS" fileiconsmall4="XML" fileiconsmall5="WORDML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert WORDML files to OPENXPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows WORDML to OPENXPS C# Conversion" offSpacer="" %}}

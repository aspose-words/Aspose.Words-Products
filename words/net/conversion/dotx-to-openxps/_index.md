---
title: Convert DOTX to OPENXPS via C# 
weight: 120
url: /net/conversion/dotx-to-openxps/ 
description: Sample code for DOTX to OPENXPS C# conversion. Use API for Batch DOTX Files to OPENXPS conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOTX to OPENXPS via C#" h2="Native and high performance DOTX to OPENXPS conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OPENXPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert DOTX files to OPENXPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOTX to OPENXPS C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOTX to OPENXPS" sectionDescription="Check our live demos for [DOTX to OPENXPS conversion](https://products.aspose.app/words/conversion/dotx-to-openxps) with following benefits." >}}

---
title: Convert RTF to TXT via C# 
weight: 4740
url: /net/conversion/rtf-to-txt/ 
description: Sample code for RTF to TXT C# conversion. Use API for Batch RTF Files to TXT conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert RTF to TXT via C#" h2="Native and high performance RTF to TXT conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RTF" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert RTF files to TXT in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows RTF to TXT C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert RTF to TXT" sectionDescription="Check our live demos for [RTF to TXT conversion](https://products.aspose.app/words/conversion/rtf-to-txt) with following benefits." >}}

---
title: Convert TXT to MOBI via C# 
weight: 11000
url: /net/conversion/txt-to-mobi/ 
description: Sample code for TXT to MOBI C# conversion. Use API for Batch TXT Files to MOBI conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TXT to MOBI via C#" h2="Native and high performance TXT to MOBI conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MOBI" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert TXT files to MOBI in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows TXT to MOBI C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert TXT to MOBI" sectionDescription="Check our live demos for [TXT to MOBI conversion](https://products.aspose.app/words/conversion/txt-to-mobi) with following benefits." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/words/net/conversion/txt-to-pdfa/" name="TXT TO PDFA" description="Portable Document Format/A" >}}

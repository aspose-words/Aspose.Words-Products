---
title: Convert OTT to PDFA via .NET 
weight: 9620
...
{{< blocks/products/pf/upper-banner h1="Convert OTT to PDFA via C#" h2="Build apps on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms that can convert OTT to PDFA." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="PDFA" pfName="Aspose.Words" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert OTT to PDFA Using C#" %}}
 ...
 In order to convert OTT to PDFA, weвЂ™ll use

---
title: Convert OTT to SVG via .NET 
weight: 9660
...
{{% blocks/products/pf/agp/content h2="How to Convert OTT to SVG Using C#" %}}
 ...
 In order to convert OTT to SVG, weвЂ™ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words makes it easy for the developers to load & convert OTT files to SVG in just a few lines of code.

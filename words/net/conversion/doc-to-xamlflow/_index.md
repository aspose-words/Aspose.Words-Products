...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert DOC files to XAMLFLOW in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOC to XAMLFLOW C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOC to XAMLFLOW" sectionDescription="Check our live demos for [DOC to XAMLFLOW conversion](https://products.aspose.app/words/conversion/doc-to-xamlflow) with following benefits." >}}

---
title: Convert DOC to JPG via C# 
url: /net/conversion/doc-to-jpg/ 
description: Sample code for DOC to JPG C# conversion. Use API for Batch DOC Files to JPG conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOC to JPG via C#" h2="Native and high performance DOC to JPG conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="JPG" fileiconsmall4="XML" fileiconsmall5="DOC" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to JPG Using C#" %}}

 In order to convert DOC to JPG, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to JPG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert DOC files to JPG in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load DOC file with an instance of Document class
1.  Call the Save method with output file path & SaveFormat.Jpg as parameters
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOC to JPG C# Conversion" offSpacer="" %}}

```cs
// load DOC with an instance of Document
var document = new Document("template.doc");
// call Save method while passing SaveFormat.Jpg
document.Save("output.jpg", SaveFormat.Jpg); 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOC to JPG" sectionDescription="Check our live demos for [DOC to JPG conversion](https://products.aspose.app/words/conversion/doc-to-jpg) with following benefits." >}}
 ...
 A Document Processing Library to perform a wide range of document management and manipulation tasks including generation, editing, conversion, rendering and printing. .NET Word API supports all of word-processing formats as well as allows exporting or converting documents to JPG, fixed-layout and most commonly used image & multimedia formats.

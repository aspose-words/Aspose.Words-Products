...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words makes it easy for the developers to load & convert DOC files to JPG in just a few lines of code.
...
document.Save("output.jpg", Aspose.Words.SaveFormat.Jpg); 

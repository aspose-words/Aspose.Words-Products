---
title: Convert DOCM to DOC via C# 
url: /net/conversion/docm-to-doc/ 
description: Sample code for DOCM to DOC C# conversion. Use API for Batch DOCM Files to DOC conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOCM to DOC via C#" h2="Native and high performance DOCM to DOC conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="DOC" fileiconsmall4="XML" fileiconsmall5="DOCM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert DOCM files to DOC in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOCM to DOC C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOCM to DOC" sectionDescription="Check our live demos for [DOCM to DOC conversion](https://products.aspose.app/words/conversion/docm-to-doc) with following benefits." >}}

---
title: Convert PDF to FLATOPCTEMPLATE via C# 
url: /net/conversion/pdf-to-flatopctemplate/ 
description: Sample code for PDF to FLATOPCTEMPLATE C# conversion. Use API for Batch PDF Files to FLATOPCTEMPLATE conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to FLATOPCTEMPLATE via C#" h2="Native and high performance PDF to FLATOPCTEMPLATE conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FLATOPCTEMPLATE" pfName="Aspose.Words" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="FLATOPCTEMPLATE" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to FLATOPCTEMPLATE C# Conversion" offSpacer="" %}}

---
title: Convert PDF to OPENXPS via C# 
url: /net/conversion/pdf-to-openxps/ 
description: Sample code for PDF to OPENXPS C# conversion. Use API for Batch PDF Files to OPENXPS conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to OPENXPS via C#" h2="Native and high performance PDF to OPENXPS conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OPENXPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OPENXPS" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to OPENXPS Using C#" %}}

 In order to convert PDF to OPENXPS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to OPENXPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert PDF files to OPENXPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to OPENXPS C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PDF to OPENXPS" sectionDescription="Check our live demos for [PDF to OPENXPS conversion](https://products.aspose.app/words/conversion/pdf-to-openxps) with following benefits." >}}

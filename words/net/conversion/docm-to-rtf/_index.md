---
title: Convert DOCM to RTF via C# 
url: /net/conversion/docm-to-rtf/ 
description: Sample code for DOCM to RTF C# conversion. Use API for Batch DOCM Files to RTF conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOCM to RTF via C#" h2="Native and high performance DOCM to RTF conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="RTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="RTF" fileiconsmall4="XML" fileiconsmall5="DOCM" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DOCM to RTF Using C#" %}}

 In order to convert DOCM to RTF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOCM to RTF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert DOCM files to RTF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOCM to RTF C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOCM to RTF" sectionDescription="Check our live demos for [DOCM to RTF conversion](https://products.aspose.app/words/conversion/docm-to-rtf) with following benefits." >}}

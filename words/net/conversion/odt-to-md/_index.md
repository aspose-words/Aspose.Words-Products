---
title: Convert ODT to MD via C# 
url: /net/conversion/odt-to-md/ 
description: Sample code for ODT to MD C# conversion. Use API for Batch ODT Files to MD conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODT to MD via C#" h2="Native and high performance ODT to MD conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="Aspose.Words" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="MD" fileiconsmall4="XML" fileiconsmall5="ODT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert ODT to MD Using C#" %}}

 In order to convert ODT to MD, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert ODT to MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Words makes it easy for the developers to load & convert ODT files to MD in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows ODT to MD C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert ODT to MD" sectionDescription="Check our live demos for [ODT to MD conversion](https://products.aspose.app/words/conversion/odt-to-md) with following benefits." >}}

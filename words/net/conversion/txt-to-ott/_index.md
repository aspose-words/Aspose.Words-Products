---
title: Convert TXT to OTT via C# 
weight: 7680
url: /net/conversion/txt-to-ott/ 
description: Sample code for TXT to OTT C# conversion. Use API for Batch TXT Files to OTT conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TXT to OTT via C#" h2="Native and high performance TXT to OTT conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert TXT files to OTT in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows TXT to OTT C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert TXT to OTT" sectionDescription="Check our live demos for [TXT to OTT conversion](https://products.aspose.app/words/conversion/txt-to-ott) with following benefits." >}}

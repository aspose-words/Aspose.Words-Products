---
title: Convert DOCX to RTF via C# 
url: /net/conversion/docx-to-rtf/ 
description: Sample code for DOCX to RTF C# conversion. Use API for Batch DOCX Files to RTF conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOCX to RTF via C#" h2="Native and high performance DOCX to RTF conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="RTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="RTF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert DOCX files to RTF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOCX to RTF C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOCX to RTF" sectionDescription="Check our live demos for [DOCX to RTF conversion](https://products.aspose.app/words/conversion/docx-to-rtf) with following benefits." >}}

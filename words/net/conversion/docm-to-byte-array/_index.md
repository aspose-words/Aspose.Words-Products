---
title: Convert DOCM to Byte Array via C# 
weight: 7690
url: /net/conversion/docm-to-byte-array/ 
description: C# Sample code for DOCM to Byte Array conversion. Use this code for Word DOCM to Byte Array conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOCM to byte array via C#" h2="Native and high performance Microsoft Word DOCM to byte array conversion or vice versa for document data processing using server side .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCM" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array is helpful for data processing or storing. You can convert DOCM file to Byte Array as well as a **Byte Array to DOCM** document using C# language. In order to convert DOCM to byte array, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 It is easy for the developers to load & convert DOCM files to byte array for further manipulation tasks in just a few lines of code.
...
1.  To convert byte array to DOCM, Load byte array to MemoryStream
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOCM to byte array C# Conversion" offSpacer="" %}}

```cs
// Create instance and load the DOCM file from disk.
Document docm = new Document("SourceSample.docm");

// Create a new memory stream.
MemoryStream outStream = new MemoryStream();
// Save the document to stream.
docm.Save(outStream, SaveFormat.Docm);

// Convert the document to byte array.
byte[] docmBytes = outStream.ToArray();

// Bytes are ready to be processed/stored.

// In order to convert byte array to DOCM
// Now reverse the steps to load the bytes back into a document object.
MemoryStream inStream = new MemoryStream(docmBytes);

// Load the stream into a new object.
Document load_docm = new Document(inStream);
// Save the file.
load_docm.Save("output.docm", SaveFormat.Docm); 

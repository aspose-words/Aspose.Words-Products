---
title: Convert MOBI to HTML via .NET 
weight: 9190
...
{{< blocks/products/pf/upper-banner h1="Convert MOBI to HTML via C#" h2="Build apps on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms that can convert MOBI to HTML." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="Aspose.Words" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MOBI" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MOBI to HTML Using C#" %}}
 ...
 In order to convert MOBI to HTML, weвЂ™ll use

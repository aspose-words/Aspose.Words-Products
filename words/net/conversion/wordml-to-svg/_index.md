---
title: Convert WORDML to SVG via C# 
url: /net/conversion/wordml-to-svg/ 
description: Sample code for WORDML to SVG C# conversion. Use API for Batch WORDML Files to SVG conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert WORDML to SVG via C#" h2="Native and high performance WORDML to SVG conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.Words" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="SVG" fileiconsmall4="XML" fileiconsmall5="WORDML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words makes it easy for the developers to load & convert WORDML files to SVG in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows WORDML to SVG C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert WORDML to SVG" sectionDescription="Check our live demos for [WORDML to SVG conversion](https://products.aspose.app/words/conversion/wordml-to-svg) with following benefits." >}}

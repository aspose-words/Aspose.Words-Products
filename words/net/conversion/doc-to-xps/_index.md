...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words makes it easy for the developers to load & convert DOC files to XPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOC to XPS C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOC to XPS" sectionDescription="Check our live demos for [DOC to XPS conversion](https://products.aspose.app/words/conversion/doc-to-xps) with following benefits." >}}

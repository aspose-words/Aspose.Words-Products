...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert DOC files to PS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOC to PS C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOC to PS" sectionDescription="Check our live demos for [DOC to PS conversion](https://products.aspose.app/words/conversion/doc-to-ps) with following benefits." >}}

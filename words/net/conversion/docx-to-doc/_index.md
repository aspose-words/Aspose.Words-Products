---
title: Convert DOCX to DOC via C# 
url: /net/conversion/docx-to-doc/ 
description: Sample code for DOCX to DOC C# conversion. Use API for Batch DOCX Files to DOC conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOCX to DOC via C#" h2="Native and high performance DOCX to DOC conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="DOC" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert DOCX files to DOC in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOCX to DOC C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOCX to DOC" sectionDescription="Check our live demos for [DOCX to DOC conversion](https://products.aspose.app/words/conversion/docx-to-doc) with following benefits." >}}

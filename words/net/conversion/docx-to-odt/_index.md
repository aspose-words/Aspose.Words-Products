...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words makes it easy for the developers to load & convert DOCX files to ODT in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOCX to ODT C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOCX to ODT" sectionDescription="Check our live demos for [DOCX to ODT conversion](https://products.aspose.app/words/conversion/docx-to-odt) with following benefits." >}}

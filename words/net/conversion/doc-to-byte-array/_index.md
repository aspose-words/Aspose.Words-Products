---
title: Convert DOC to Byte Array via C# 
weight: 7690
url: /net/conversion/doc-to-byte-array/ 
description: C# Sample code for DOC to Byte Array conversion. Use this code for Word DOC to Byte Array conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOC to byte array via C#" h2="Native and high performance Microsoft Word DOC to byte array conversion or vice versa for document data processing using server side .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOC" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array is helpful for data processing or storing. You can convert DOC file to Byte Array as well as a **Byte Array to DOC** document using C# language. In order to convert DOC to byte array, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert DOC to Byte Array via C#" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to load & convert DOC files to byte array for further manipulation tasks in just a few lines of code.
...
1.  To convert byte array to DOC, Load byte array to MemoryStream
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOC to byte array C# Conversion" offSpacer="" %}}

```cs
// Create instance and load the DOC file from disk.
Document doc = new Document("SourceSample.doc");
...
// In order to convert byte array to DOC
// Now reverse the steps to load the bytes back into a document object.
MemoryStream inStream = new MemoryStream(docBytes);

// Load the stream into a new object.
Document load_doc = new Document(inStream);
// Save the file.
load_doc.Save("output.doc", SaveFormat.Doc); 

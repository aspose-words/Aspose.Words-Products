...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert DOC files to OPENXPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOC to OPENXPS C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOC to OPENXPS" sectionDescription="Check our live demos for [DOC to OPENXPS conversion](https://products.aspose.app/words/conversion/doc-to-openxps) with following benefits." >}}

---
title: Convert DOTX to DOC via C# 
url: /net/conversion/dotx-to-doc/ 
description: Sample code for DOTX to DOC C# conversion. Use API for Batch DOTX Files to DOC conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOTX to DOC via C#" h2="Native and high performance DOTX to DOC conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="DOC" fileiconsmall4="XML" fileiconsmall5="DOTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DOTX to DOC Using C#" %}}

 In order to convert DOTX to DOC, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOTX to DOC via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert DOTX files to DOC in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOTX to DOC C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOTX to DOC" sectionDescription="Check our live demos for [DOTX to DOC conversion](https://products.aspose.app/words/conversion/dotx-to-doc) with following benefits." >}}

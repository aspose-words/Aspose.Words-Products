---
title: Convert DOT to RTF via C# 
url: /net/conversion/dot-to-rtf/ 
description: Sample code for DOT to RTF C# conversion. Use API for Batch DOT Files to RTF conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOT to RTF via C#" h2="Native and high performance DOT to RTF conversion using server side .NET APIs, without the use of any software like Microsoft Word, OpenOffice or Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="RTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="RTF" fileiconsmall4="XML" fileiconsmall5="DOT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert DOT files to RTF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOT to RTF C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOT to RTF" sectionDescription="Check our live demos for [DOT to RTF conversion](https://products.aspose.app/words/conversion/dot-to-rtf) with following benefits." >}}

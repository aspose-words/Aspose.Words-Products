...
{{% blocks/products/pf/agp/content h2="How to Digitally Sign RTF File Using C#" %}}
 ...
 In order to electronically sign RTF file, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps forВ e-SigningВ RTF Files in C#" %}}
...
+  SaveВ RTF file, You will get the document with signature inserted.
...
{{% blocks/products/pf/agp/code-block title="e-SignВ RTF Files - C#" offSpacer="" %}}

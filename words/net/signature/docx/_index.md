...
{{% blocks/products/pf/agp/content h2="How to Digitally Sign DOCX File Using C#" %}}
 ...
 In order to electronically sign DOCX file, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps forВ e-SigningВ DOCX Files in C#" %}}
...
+  SaveВ DOCX file, You will get the document with signature inserted.
...
{{% blocks/products/pf/agp/code-block title="e-SignВ DOCX Files - C#" offSpacer="" %}}

...
weight: 4330
url: /net/viewer/rtf/ 
description: Load, render and display RTF documents on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="How to View RTF File Using C#" %}}

 In order to view RTF file, we’ll use
...
{{% blocks/products/pf/agp/code-block title="View RTF file using C# example code" offSpacer="" %}}

...
weight: 320
url: /net/viewer/html/ 
description: Load, render and display HTML documents on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words makes it easy for the developers to view the HTML file with just few lines of code.
...
var document = new Aspose.Words.Document("template.html");

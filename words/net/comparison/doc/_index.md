...
description: C# sample code to compare Microsoft Word DOC documents for differences using server side .NET library.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily compare two versions of DOC document to get the differences.

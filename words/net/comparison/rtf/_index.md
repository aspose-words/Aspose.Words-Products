---
title: Compare RTF Files via .NET 
weight: 2900
url: /net/comparison/rtf/ 
description: C# sample code to compare Microsoft Word RTF documents for differences using server side .NET library.
---
...
{{% blocks/products/pf/agp/content h2="How to Compare RTF File Using C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily compare two versions of RTF document to get the differences.

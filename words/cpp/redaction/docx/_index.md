...
description: Try our On-Premise document redaction APIs to redact sensitive information in DOCX file on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---
...
```cs
// Load DOCX document
System::SharedPtr<Document> docx = System::MakeObject<Document>(u"Document.docx");

// Create find and replace options
System::SharedPtr<FindReplaceOptions> options = System::MakeObject<FindReplaceOptions>();

// Find and replace the text
docx->get_Range()->Replace(System::MakeObject<System::Text::RegularExpressions::Regex>(u"[s|m]ad"), u"bad", options);

// Save the updated document 
docx->Save(u"updated.docx");

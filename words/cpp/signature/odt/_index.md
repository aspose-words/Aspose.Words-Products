...
System::String outputPath = outputDataDir + u"SigningSignatureLine.SimpleDocumentSigning_out.odt";
DigitalSignatureUtil::Sign(inputDataDir + u"Document.Signed.odt", outputPath, certHolder);  

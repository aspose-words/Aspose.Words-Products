...
description: Try our On-Premise document electronic signature APIs to eSgin HTML documents on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---
...
System::String outputPath = outputDataDir + u"SigningSignatureLine.SimpleDocumentSigning_out.html";
DigitalSignatureUtil::Sign(inputDataDir + u"Document.Signed.html", outputPath, certHolder);  

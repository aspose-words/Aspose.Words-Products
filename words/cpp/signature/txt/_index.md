...
{{% blocks/products/pf/agp/content h2="How to Digitally Sign TXT File Using C++" %}}
 ...
 In order to electronically sign TXT file, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps forВ e-SigningВ TXT Files in C++" %}}
...
{{% blocks/products/pf/agp/code-block title="e-SignВ TXT Files - C++" offSpacer="" %}}

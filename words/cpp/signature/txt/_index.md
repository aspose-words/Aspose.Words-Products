---
title: e-Sign TXT Documents via C++ 
weight: 1630
url: /cpp/signature/txt/ 
description: Try our On-Premise document electronic signature APIs to eSgin TXT documents on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="eSign TXT Formats in C++" h2="Native and high performance TXT document electronic signature using server-side Aspose.Words for C++ APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
System::String outputPath = outputDataDir + u"SigningSignatureLine.SimpleDocumentSigning_out.txt";
DigitalSignatureUtil::Sign(inputDataDir + u"Document.Signed.txt", outputPath, certHolder);  

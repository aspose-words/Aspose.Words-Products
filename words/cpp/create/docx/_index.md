...
weight: 7690
url: /cpp/create/docx/ 
description: C++ Sample code for generating DOCX documents. Use this code for creating Word DOCX files within C++ based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Create DOCX File via C++" h2="Native and high performance Microsoft Word DOCX documents creation programmatically using C++ library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
System::SharedPtr<Document> docx = System::MakeObject<Document>();
// Document builder for adding content within the document.
System::SharedPtr<DocumentBuilder> bldr = System::MakeObject<DocumentBuilder>(docx);
// Add all relevant content
bldr->Writeln(u"relevant content!"); 
// Save the document to any specified location.
docx->Save(u"document.docx"); 

// Enhance the code to edit or update the created Word DOCX file
...
A Document Processing Library to perform a wide range of document creation, management and manipulation tasks including DOCX generation, editing, conversion, rendering and printing. C++ Word library supports all of word-processing formats as well as allows exporting or converting DOCX to PDF, HTML, fixed-layout and most commonly used image & multimedia formats.

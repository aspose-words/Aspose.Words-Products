---
title: Protect and lock DOTX document via C++ 
weight: 5100
url: /cpp/protect/dotx/ 
description: Try our On-Premise document APIs to lock DOTX file using password on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Encrypt DOTX Files via C++" h2="Password-protect Word documents including DOTX format using .NET Library." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-cpp.png" sourceAdditionalConversionTag="" additionalConversionTag="DOTX" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Secure DOTX File Using C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Protect DOTX Files via C++" %}}

...
{{% blocks/products/pf/agp/content h2="How to Search XHTML File Using C++" %}}
 ...
 In order to search XHTML file, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="StepsВ to SearchВ XHTML Files in C++" %}}
...
+  Save XHTML file using Save() method.
...
{{% blocks/products/pf/agp/code-block title="SearchВ XHTML Files - C++" offSpacer="" %}}

```cs
// Load XHTML document
System::SharedPtr<Document> xhtml = System::MakeObject<Document>(u"sourceFile.xhtml");

// Find and replace the text
xhtml->get_Range()->Replace(u"sad", u"bad", System::MakeObject<FindReplaceOptions>(FindReplaceDirection::Forward));

// Save the document 
xhtml->Save(u"output.xhtml");  
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XHTMLВ SearchВ Live Demos" sectionDescription="Search text, words, phrasesВ within XHTML documents right now by visiting our [Live Demos website](https://products.aspose.app/words/search). The live demo has the following benefits" >}}
    ...
    {{< blocks/products/pf/agp/about-file-text fileFormat="XHTMLВ " readMoreLink="https://docs.fileformat.com/web/xhtml/" >}}

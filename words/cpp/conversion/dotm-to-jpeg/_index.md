...
{{% blocks/products/pf/agp/content h2="How to Convert DOTM to JPEG Using C++" %}}

 In order to convert DOTM to JPEG, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOTM to JPEG via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="DOTM to JPEG C++ Conversion Source Code" offSpacer="" %}}

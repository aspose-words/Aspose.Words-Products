---
title: Convert ODT to OTT via C++ application 
url: /cpp/conversion/odt-to-ott/ 
description: Sample C++ conversion code for ODT file to OTT format. Programmers can use this example code for batch ODT document to OTT conversion within any C++ Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODT to OTT via C++" h2="High performance ODT to OTT conversion using C++ library without the need of Microsoft Word, OpenOffice or Adobe Acrobat installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTT" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODT" >}}
...
{{% blocks/products/pf/agp/code-block title="ODT to OTT C++ Conversion Source Code" offSpacer="" %}}

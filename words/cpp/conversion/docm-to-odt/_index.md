---
title: Convert DOCM to ODT via C++ application 
weight: 7940
url: /cpp/conversion/docm-to-odt/ 
description: Sample C++ conversion code for DOCM file to ODT format. Programmers can use this example code for batch DOCM document to ODT conversion within any C++ Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOCM to ODT via C++" h2="High performance DOCM to ODT conversion using C++ library without the need of Microsoft Word, OpenOffice or Adobe Acrobat installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODT" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCM" >}}
...
{{% blocks/products/pf/agp/code-block title="DOCM to ODT C++ Conversion Source Code" offSpacer="" %}}

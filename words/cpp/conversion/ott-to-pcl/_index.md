---
title: Convert OTT to PCL via C++ application 
url: /cpp/conversion/ott-to-pcl/ 
description: Sample C++ conversion code for OTT file to PCL format. Programmers can use this example code for batch OTT document to PCL conversion within any C++ Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTT to PCL via C++" h2="High performance OTT to PCL conversion using C++ library without the need of Microsoft Word, OpenOffice or Adobe Acrobat installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PCL" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert OTT to PCL Using C++" %}}

 In order to convert OTT to PCL, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert OTT to PCL via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="OTT to PCL C++ Conversion Source Code" offSpacer="" %}}

...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOTM to GIF via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="DOTM to GIF C++ Conversion Source Code" offSpacer="" %}}

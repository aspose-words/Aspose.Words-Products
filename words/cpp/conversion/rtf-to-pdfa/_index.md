---
title: Convert RTF to PDFA via C++ application 
url: /cpp/conversion/rtf-to-pdfa/ 
description: Sample C++ conversion code for RTF file to PDFA format. Programmers can use this example code for batch RTF document to PDFA conversion within any C++ Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert RTF to PDFA via C++" h2="High performance RTF to PDFA conversion using C++ library without the need of Microsoft Word, OpenOffice or Adobe Acrobat installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDFA" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RTF" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words API makes it easy for the developers to convert RTF file to PDFA in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="RTF to PDFA C++ Conversion Source Code" offSpacer="" %}}

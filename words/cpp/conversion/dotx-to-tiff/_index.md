---
title: Convert DOTX to TIFF via C++ application 
url: /cpp/conversion/dotx-to-tiff/ 
description: Sample C++ conversion code for DOTX file to TIFF format. Programmers can use this example code for batch DOTX document to TIFF conversion within any C++ Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOTX to TIFF via C++" h2="High performance DOTX to TIFF conversion using C++ library without the need of Microsoft Word, OpenOffice or Adobe Acrobat installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOTX" >}}
...
{{% blocks/products/pf/agp/code-block title="DOTX to TIFF C++ Conversion Source Code" offSpacer="" %}}

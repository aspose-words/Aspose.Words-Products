...
{{< blocks/products/pf/i18n/upper-banner h1="C++ API voor het verwerken van Word-documenten" h2="Genereer, bewerk, converteer en render Microsoft Word-documenten in de C++-toepassing zonder dat u Microsoft Word nodig heeft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-cpp.svg" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/words/cpp" >}}
...
<p><strong>Aspose.Words for C++</strong> is een geavanceerde Word Document Processing API om een breed scala aan verwerkingstaken uit te voeren. De API van Words biedt documentopmaak, manipulatie, mail merge, watermerken en nog veel meer mogelijkheden rechtstreeks binnen uw eigen C++-applicaties zonder dat Microsoft Word nodig is.</p>
<p>Aspose.Words API ondersteunt de meeste Microsoft Word-indelingen en kan de documentpagina's naar een aantal afbeeldingsindelingen weergeven. Zo kunt u werken met documenten in DOC, DOCX, PDF, RTF, DOT, DOTX, DOTM, DOCM, FlatOPC, ODT, OTT, HTML, MHTML, MOBI, TXT, XPS, PS, TIFF, JPEG, PNG, BMP, SVG, EMF, GIF, PCL, EPUB, XML, XAML en meer. Je kan zien <a href="https://docs.aspose.com/words/cpp/supported-document-formats/">de volledige lijst met ondersteunde formaten</a>.</p>
<h2 class="h2title">Functionality of Aspose.Words for C++</h2>
<p>Aspose.Words is een op zichzelf staande C++-bibliotheek. U hoeft geen extra toepassingen te installeren om uw C++-code werkend te krijgen. Deze C++ API is gebaseerd op de <a href="https://docs.aspose.com/words/cpp/aspose-words-document-object-model/">Documentobjectmodel (DOM)</a> om toegang te krijgen tot documentknooppunten en -elementen.</p>
{{< /blocks/products/pf/i18n/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/i18n/carousel >}}

{{< blocks/products/pf/carousel-item h3="In een oogopslag" description="Een algemeen overzicht van de mogelijkheden van API." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Secties, kop- en voetteksten
    </li>
    <li>
     Voetnoten, eindnoten en opmerkingen
    </li>
   </ul>
  </div>
  <!--/right-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ tekstverwerkingsbibliotheek" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="De bibliotheek ondersteunt volledig C++-applicaties die zijn ontwikkeld op de volgende platforms met: [systeem vereisten](https://docs.aspose.com/words/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API's voor manipulatie van Word-documenten" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="Aspose.Words voor C++ ondersteunt de meest populaire [Tekstverwerking bestandsformaten](https://docs.aspose.com/words/cpp/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ Word-programmeer-API's" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Geavanceerde C++ Word API-functies
   </h2>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/convert-a-document/">Een document converteren</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/rendering/">Een document renderen naar formaten met een vaste lay-out</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/compare-documents/">Documenten vergelijken</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/clone-a-document/">Een document klonen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/insert-and-append-documents/">Documenten samenvoegen: invoegen en toevoegen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/split-a-document/">Bestanden splitsen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/find-and-replace/">Tekst zoeken en vervangen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/protect-or-encrypt-a-document/">Een document beveiligen of coderen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-digital-signatures/">Werken met digitale handtekeningen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/mail-merge-and-reporting/">Afdruk samenvoegen en rapportage</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-watermark/">Watermerk toevoegen aan een document</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-tables/">Werken met tabellen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-fields/">Velden invoegen, bijwerken of verwijderen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/programming-with-documents/">Alle documentelementen opmaken</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-comments/">Werken met opmerkingen en revisies</a>
    </p>
   </div>
   <div>
   <p>
     Houd er rekening mee dat de lijst niet compleet is en dat u meer functies en beschrijvingen kunt vinden in de <a href="https://docs.aspose.com/words/cpp/developer-guide/">documentation</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Programmeren met Document Object Model
    </h2>
    <p>
     ...
     API stelt C++-applicaties in staat om het maken van Microsoft Word-bestanden te automatiseren en om bestanden te openen en te wijzigen, inclusief opmaak met een intuïtief documentobjectmodel dat qua terminologie en functies Microsoft Word nabootst. C++-ontwikkelaars kunnen dynamisch alle elementen creëren, wijzigen, extraheren en vervangen, inclusief secties, alinea's, tabellen, bladwijzers, velden, formuliervelden, opmerkingen, afbeeldingen, stijlen enzovoort.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Een document converteren in C++
    </h2>
    <p>
     Converteer een bestand van het ene ondersteunde formaat naar het andere met slechts twee regels code. Het is zo eenvoudig!
    </p>
...
doc->Save(outputPath);
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Documenten samenvoegen of toevoegen in C++
    </h2>
    <p>
     Aspose.Words voor C++ ondersteunt het samenvoegen en toevoegen van meerdere bestanden in één. Dit proces is heel eenvoudig en configureerbaar en biedt de mogelijkheid om te bepalen hoe de bestanden worden samengevoegd. C++ Tekstverwerkingsbibliotheek maakt het ook mogelijk om de paginanummering opnieuw in te stellen nadat de documenten zijn samengevoegd.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Twee bestanden samenvoegen - C++
     </h3>
     <pre><code class="cpp">
...
// Stel het bijgevoegde bestand in om op een nieuwe pagina te beginnen.
srcDoc->get_FirstSection()->get_PageSetup()->set_SectionStart(SectionStart::NewPage); 

// Voeg het bronbestand toe met de originele stijlen in het bronbestand.
...
dstDoc->Save(dir + u"output.doc);</code></pre>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Documentbeveiliging gebruiken in C++
    </h2>
    <p>
     Aspose.Words voor C++ biedt de mogelijkheid om documenten te beschermen en de beveiliging op te heffen met een enkele regel code. U kunt de beveiliging zo instellen dat de gebruiker slechts beperkte wijzigingen kan aanbrengen, zoals het toevoegen van annotaties, het maken van revisies of het invullen van een formulier.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Bestanden beveiligen en de beveiliging opheffen – C++
     </h3>
     <pre><code class="cpp">
// Laad een te verwerken document.
auto wrdoc = System::MakeObject&lt;Document&gt;(dir + u"template.doc");

// Bescherm het bestand.
...
{{< blocks/products/pf/slr-element name="Documentatie" href="https://docs.aspose.com/words/cpp/" >}}
{{< blocks/products/pf/slr-element name="Broncode" href="https://github.com/aspose-words/Aspose.Words-for-C" >}}
{{< blocks/products/pf/slr-element name="API-referenties" href="https://apireference.aspose.com/words/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.Words voor C++?" tabId="success-stories" >}}

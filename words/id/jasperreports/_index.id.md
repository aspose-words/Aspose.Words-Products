...
{{< blocks/products/pf/i18n/upper-banner h1="Ekstensi JasperReports untuk Mengekspor Laporan dalam Format Word" h2="Ekspor laporan ke format Word dan HTML dari JasperReports dan JasperServer." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-jasperreports.svg" pfName="Aspose.Words" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/words/jasperreports" >}}
...
{{< blocks/products/pf/carousel-item h3="Sekilas" description="Fitur Aspose.Words untuk JasperReports." >}}
<div class="diagram1 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="JasperMelaporkan ke Eksportir Kata" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platform Kemerdekaan" description="Aspose.Words untuk JasperReports mendukung J2SE, JasperReports dan JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
  ...
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 3.0 atau lebih tinggi
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
    </i>
    JasperServer 3.7.1 atau lebih tinggi
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports Server 7.1.0 atau lebih tinggi
   </header>
  </div>
  <!--/right-->
 </div>
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Konverter JasperReports ke DOC" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Aspose.Words untuk JasperReports mendukung pengolah kata, teks, dan web yang paling populer [format berkas](https://docs.aspose.com/words/jasperreports/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Eksportir JasperReports untuk Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     Dukungan untuk Format Microsoft Word Paling Populer
    </h2>
    <p>
     Aspose.Words untuk JasperReports memungkinkan Anda mengekspor laporan sebagai dokumen DOC dan DOCX dari JasperReports dan JasperServer. Dibandingkan dengan RTF, format ini menawarkan sejumlah keunggulan seperti ukuran file yang lebih kecil, peningkatan pemformatan konten, dan kemudahan pengeditan oleh pengguna akhir.
    </p>
    <p>
     Selain format Microsoft Word, Aspose.Words untuk JasperReports menawarkan kemampuan untuk mengekspor laporan dalam format RTF, ODT, HTML, dan TXT.
    </p>
   </div>
   <!--
...
<h2 class="h2title">Easy & Penerapan Ringan</h2>
...
-->
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words untuk JasperReports mengekspor laporan ke dokumen Microsoft Word sedemikian rupa sehingga hasilnya tampak identik dengan desain laporan asli seperti yang dibuat oleh perancang laporan JasperReports bawaan. Semua fitur laporan dikonversi ke tingkat presisi tertinggi untuk membuat dokumen Microsoft Word terlihat sedekat mungkin dengan desain aslinya.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words untuk JasperReports mengekspor dokumen tata letak alur. Ini berarti dokumen terdiri dari: "
     <strong>
      normal
     </strong>
     " paragraf, tabel, dan gambar yang mudah diedit lebih lanjut di Microsoft Word, jika perlu. Eksportir RTF JasperReports bawaan menghasilkan dokumen yang terdiri dari bingkai teks yang diposisikan, yang membuat pengeditan oleh pengguna akhir menjadi tugas yang kurang intuitif.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words for JasperReports dibuat menggunakan kode terkelola yang tidak pernah membutuhkan Microsoft Word untuk diinstal pada mesin untuk bekerja dengan format dokumen Word. Ini adalah alternatif otomatisasi Microsoft Word yang sempurna dalam hal fitur yang didukung, keamanan, stabilitas, skalabilitas, kecepatan, dan harga.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Dokumentasi" href="https://docs.aspose.com/words/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Mengapa Aspose.Words untuk JasperReports?" tabId="success-stories" >}}

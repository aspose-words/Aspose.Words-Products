...
{{< blocks/products/pf/i18n/upper-banner h1="API Pemrosesan Dokumen Word C++" h2="Buat, edit, konversi, dan render dokumen Microsoft Word di aplikasi C++ tanpa memerlukan Microsoft Word." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-cpp.svg" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/words/cpp" >}}
...
<p><strong>Aspose.Words for C++</strong> adalah API Pemrosesan Dokumen Word tingkat lanjut untuk melakukan berbagai tugas pemrosesan. Words 'API menyediakan pemformatan dokumen, manipulasi, penggabungan surat, watermarking, dan banyak lagi kemampuan langsung di dalam aplikasi C++ Anda sendiri tanpa memerlukan Microsoft Word.</p>
<p>Aspose.Words API mendukung sebagian besar format Microsoft Word, dan dapat merender halaman dokumen ke sejumlah format gambar. Dengan demikian, Anda dapat bekerja dengan dokumen dalam DOC, DOCX, PDF, RTF, DOT, DOTX, DOTM, DOCM, FlatOPC, ODT, OTT, HTML, MHTML, MOBI, TXT, XPS, PS, TIFF, JPEG, PNG, BMP, SVG, EMF, GIF, PCL, EPUB, XML, XAML, dan lainnya. Anda bisa melihat <a href="https://docs.aspose.com/words/cpp/supported-document-formats/">daftar lengkap format yang didukung</a>.</p>
<h2 class="h2title">Functionality of Aspose.Words for C++</h2>
<p>Aspose.Words adalah pustaka C++ mandiri. Anda tidak perlu menginstal aplikasi tambahan agar kode C++ Anda berfungsi. C++ API ini bergantung pada <a href="https://docs.aspose.com/words/cpp/aspose-words-document-object-model/">Model Objek Dokumen (DOM)</a> untuk mengakses node dokumen dan elemen.</p>
{{< /blocks/products/pf/i18n/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/i18n/carousel >}}

{{< blocks/products/pf/carousel-item h3="Sekilas" description="Pandangan umum tentang kemampuan API." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Catatan Kaki, Catatan Akhir, dan Komentar
    </li>
   </ul>
  </div>
  <!--/right-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Pustaka Pemrosesan Kata C++" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Platform Kemerdekaan" description="Pustaka mendukung sepenuhnya aplikasi C++ yang dikembangkan pada platform berikut yang memiliki [Persyaratan sistem](https://docs.aspose.com/words/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API Manipulasi Dokumen Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Aspose.Words untuk C++ mendukung yang paling populer [Format file pengolah kata](https://docs.aspose.com/words/cpp/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API Pemrograman Kata C++" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/convert-a-document/">Mengonversi Dokumen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/rendering/">Render Dokumen ke Format Tata Letak Tetap</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/compare-documents/">Bandingkan Dokumen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/clone-a-document/">Mengkloning Dokumen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/insert-and-append-documents/">Bergabung dengan dokumen: masukkan dan tambahkan</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/split-a-document/">Pisahkan File</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/find-and-replace/">Temukan dan ganti teks</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/protect-or-encrypt-a-document/">Melindungi atau Mengenkripsi Dokumen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-digital-signatures/">Bekerja dengan Tanda Tangan Digital</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/mail-merge-and-reporting/">Gabungan Surat dan Pelaporan</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-watermark/">Tambahkan Tanda Air ke Dokumen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-tables/">Bekerja dengan Tabel</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-fields/">Sisipkan, Perbarui, atau Hapus Bidang</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/programming-with-documents/">Format Semua Elemen Dokumen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-comments/">Bekerja dengan Komentar dan Revisi</a>
    </p>
   </div>
   <div>
   <p>
     Harap dicatat bahwa daftar ini tidak lengkap dan Anda dapat menemukan lebih banyak fitur dan deskripsi di <a href="https://docs.aspose.com/words/cpp/developer-guide/">documentation</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Dokumentasi" href="https://docs.aspose.com/words/cpp/" >}}
{{< blocks/products/pf/slr-element name="Kode sumber" href="https://github.com/aspose-words/Aspose.Words-for-C" >}}
{{< blocks/products/pf/slr-element name="Referensi API" href="https://apireference.aspose.com/words/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Mengapa Aspose.Words untuk C++?" tabId="success-stories" >}}

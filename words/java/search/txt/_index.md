...
weight: 7120
url: /java/search/txt/ 
description: Integrate On-Premise document APIs to search words with pattern in TXT file on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Search TXT FormatsВ in Java" h2="Native and high performance TXT documentВ search using server-side Aspose.Words for Java APIs, without the use of any software like Microsoft or Adobe PDF." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Search TXT File Using Java" %}}
 ...
 In order to search TXT file, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="StepsВ to SearchВ TXT Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="SearchВ TXT Files - Java" offSpacer="" %}}

```cs
// Load TXT file
Document txt = new Document("sourceFile.txt");
// Find and replace similar pattern words in the file
FindReplaceOptions options = new FindReplaceOptions();
txt.getRange().replace(Pattern.compile("[B|S|M]ad"), "[replaced]", options);
// Save the TXT file
txt.save("output.txt");  
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online TXTВ SearchВ Live Demos" sectionDescription="Search text, words, phrasesВ within TXT documents right now by visiting our [Live Demos website](https://products.aspose.app/words/search). The live demo has the following benefits" >}}

...
weight: 8430
url: /java/search/doc/ 
description: Java source code to search words with pattern in DOC file on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Search DOC Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Search DOC Files - Java" offSpacer="" %}}

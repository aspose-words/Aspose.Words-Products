...
description: Try our On-Premise document metadata editing or viewer APIs to edit or view ODT format metadata on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Extract ODT Metadata via Java" h2="Build your own Java apps to add, edit, remove or extract metadata from ODT files using server-side APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="ODT" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Extract ODT Metadata Using Java" %}}

 In order to get ODT file metadata, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Extract Metadata of ODT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Extract Metadata of ODT - Java" offSpacer="" %}}

```cs

Document odtSource = new Document("document.odt");
System.out.println("============ Built-in Properties ============");
for (DocumentProperty prop : odtSource.getBuiltInDocumentProperties())
    System.out.println(MessageFormat.format("{0} : {1}", prop.getName(), prop.getValue()));
System.out.println("============ Custom Properties ============");
for (DocumentProperty prop : odtSource.getCustomDocumentProperties())
    System.out.println(MessageFormat.format("{0} : {1}", prop.getName(), prop.getValue()));
FileFormatInfo info = FileFormatUtil.detectFileFormat("document.odt");

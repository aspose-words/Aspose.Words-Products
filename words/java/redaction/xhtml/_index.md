...
{{% blocks/products/pf/agp/content h2="How to Redact XHTML File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Redact XHTML Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Redact XHTML Files - Java" offSpacer="" %}}

...
{{% blocks/products/pf/agp/content h2="How to Redact HTML File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Redact HTML Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Redact HTML Files - Java" offSpacer="" %}}

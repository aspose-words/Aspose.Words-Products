...
{{% blocks/products/pf/agp/feature-section-col title="StepsВ to Redact DOTX Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="RedactВ DOTX Files - Java" offSpacer="" %}}

...
description: Java source code to redact sensitive information in DOC file on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Redact DOC Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Redact DOC Files - Java" offSpacer="" %}}

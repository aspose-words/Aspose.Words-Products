...
{{% blocks/products/pf/agp/feature-section-col title="StepsВ to Redact TXT Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="RedactВ TXT Files - Java" offSpacer="" %}}

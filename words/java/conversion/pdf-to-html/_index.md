...
description: Sample Java conversion code for PDF format to HTML file. Programmers can use this example code for multiple PDF to HTML files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to HTML via Java" h2="PDF to HTML Java conversion to convert single or multiple pages to HTML documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PDFX" fileiconsmall2="JPG" fileiconsmall3="HTML" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words API makes it easy for the developers to convert PDF file to HTML in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for PDF to HTML Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PDF to HTML Conversion Live Demos" sectionDescription="[Convert PDF to HTML](https://products.aspose.app/words/conversion/pdf-to-html) right now by visiting our Live Demos website.The live demo has the following benefits" >}}

---
title: Convert DOCM to MOBI via Java 
url: /java/conversion/docm-to-mobi/ 
description: Sample Java conversion code for DOCM format to MOBI file. Programmers can use this example code for multiple DOCM to MOBI files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOCM to MOBI via Java" h2="DOCM to MOBI Java conversion to convert single or multiple pages to MOBI documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MOBI" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCMX" fileiconsmall2="JPG" fileiconsmall3="MOBI" fileiconsmall4="XML" fileiconsmall5="DOCM" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DOCM to MOBI Using Java" %}}

 In order to render DOCM to MOBI, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOCM to MOBI via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOCM to MOBI Conversion" offSpacer="" %}}

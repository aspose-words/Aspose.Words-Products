...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to DOT Using Java" %}}

 In order to render DOC to DOT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to DOT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert DOC file to DOT in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOC to DOT Conversion" offSpacer="" %}}

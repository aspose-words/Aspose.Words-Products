...
{{% blocks/products/pf/agp/content h2="How to Convert WORDML to XAMLFLOW Using Java" %}}

 In order to render WORDML to XAMLFLOW, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert WORDML to XAMLFLOW via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert WORDML file to XAMLFLOW in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for WORDML to XAMLFLOW Conversion" offSpacer="" %}}

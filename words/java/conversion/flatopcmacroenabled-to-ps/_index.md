---
title: Convert FLATOPCMACROENABLED to PS via Java 
url: /java/conversion/flatopcmacroenabled-to-ps/ 
description: Sample Java conversion code for FLATOPCMACROENABLED format to PS file. Programmers can use this example code for multiple FLATOPCMACROENABLED to PS files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FLATOPCMACROENABLED to PS via Java" h2="FLATOPCMACROENABLED to PS Java conversion to convert single or multiple pages to PS documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PS" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="FLATOPCMACROENABLEDX" fileiconsmall2="JPG" fileiconsmall3="PS" fileiconsmall4="XML" fileiconsmall5="FLATOPCMACROENABLED" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert FLATOPCMACROENABLED to PS Using Java" %}}

 In order to render FLATOPCMACROENABLED to PS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert FLATOPCMACROENABLED to PS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for FLATOPCMACROENABLED to PS Conversion" offSpacer="" %}}

---
title: Convert TXT to PDFA via Java 
url: /java/conversion/txt-to-pdfa/ 
description: Sample Java conversion code for TXT format to PDFA file. Programmers can use this example code for multiple TXT to PDFA files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TXT to PDFA via Java" h2="TXT to PDFA Java conversion to convert single or multiple pages to PDFA documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDFA" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="TXTX" fileiconsmall2="JPG" fileiconsmall3="PDFA" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to PDFA Using Java" %}}

 In order to render TXT to PDFA, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TXT to PDFA via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert TXT file to PDFA in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for TXT to PDFA Conversion" offSpacer="" %}}

...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to BMP Using Java" %}}

 In order to render DOC to BMP, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to BMP via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOC to BMP Conversion" offSpacer="" %}}

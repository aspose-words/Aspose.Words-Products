...
{{% blocks/products/pf/agp/content h2="How to Convert RTF to JPEG Using Java" %}}

 In order to render RTF to JPEG, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert RTF to JPEG via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for RTF to JPEG Conversion" offSpacer="" %}}

---
title: Convert MHTML to DOCM via Java 
weight: 1140
url: /java/conversion/mhtml-to-docm/ 
description: Sample Java conversion code for MHTML format to DOCM file. Programmers can use this example code for multiple MHTML to DOCM files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MHTML to DOCM via Java" h2="MHTML to DOCM Java conversion to convert single or multiple pages to DOCM documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCM" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MHTML to DOCM Using Java" %}}

 In order to render MHTML to DOCM, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MHTML to DOCM via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for MHTML to DOCM Conversion" offSpacer="" %}}

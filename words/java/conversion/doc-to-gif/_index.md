...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to GIF Using Java" %}}

 In order to render DOC to GIF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to GIF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOC to GIF Conversion" offSpacer="" %}}

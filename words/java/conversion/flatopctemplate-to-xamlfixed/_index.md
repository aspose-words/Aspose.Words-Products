...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words API makes it easy for the developers to convert FLATOPCTEMPLATE file to XAMLFIXED in just a few lines of code.

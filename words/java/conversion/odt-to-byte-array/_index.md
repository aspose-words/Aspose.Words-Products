---
title: Convert ODT to Byte Array via Java 
weight: 7690
url: /java/conversion/odt-to-byte-array/ 
description: Java example code for ODT to Byte Array conversion. Use this code for Word ODT to Byte Array conversion within any Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODT to byte array via Java" h2="DOCX to byte array Java conversion for document data processing using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert ODT to Byte Array via Java" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the Java developers to load & convert ODT files to byte array for further manipulation tasks in just a few lines of code.
...
1.  To convert byte array to ODT, Load byte array to ByteArrayInputStream
...
{{% blocks/products/pf/agp/code-block title="This sample code shows ODT to byte array Java Conversion" offSpacer="" %}}

```cs
// Load the file.
Document odt = new Document("soureSample.odt");

// Create a new memory stream.
ByteArrayOutputStream out_Stream = new ByteArrayOutputStream();
// Save to stream.
odt.save(out_Stream, SaveFormat.ODT);

// Convert the document to byte array form.
byte[] odt_Bytes = out_Stream.toByteArray();

// The bytes are now ready to be stored/processed.

// Now reverse the steps to load the bytes back into a document object.
ByteArrayInputStream in_Stream = new ByteArrayInputStream(odt_Bytes);

// Load the stream into a new document object.
Document load_Odt = new Document(in_Stream);
// Save the document.
load_Odt.save("convertback.odt",SaveFormat.ODT);
...
A Document Processing Library to perform a wide range of document management and manipulation tasks including ODT generation, editing, conversion, rendering and printing. .NET Word API supports all of word-processing formats as well as allows exporting or **converting ODT to HTML**, PDF, fixed-layout and most commonly used image & multimedia formats.

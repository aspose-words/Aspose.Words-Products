---
title: Convert TXT to DOC via Java 
weight: 7760
url: /java/conversion/txt-to-doc/ 
description: Sample Java conversion code for TXT format to DOC file. Programmers can use this example code for multiple TXT to DOC files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TXT to DOC via Java" h2="TXT to DOC Java conversion to convert single or multiple pages to DOC documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to DOC Using Java" %}}

 In order to render TXT to DOC, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TXT to DOC via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for TXT to DOC Conversion" offSpacer="" %}}

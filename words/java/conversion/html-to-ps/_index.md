...
{{< blocks/products/pf/upper-banner h1="Convert HTML to PS via Java" h2="Native Java library to export Microsoft Word & OpenOffice documents to PS." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PS" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert HTML to PS Using Java" %}}
 ...
 In order to render HTML to PS, weвЂ™ll use
...
{{% blocks/products/pf/agp/code-block title="Convert HTML to PS - JavaвЂЋ" offSpacer="" %}}

---
title: Convert DOCX to Byte Array via Java 
weight: 7690
url: /java/conversion/docx-to-byte-array/ 
description: Java example code for DOCX to Byte Array conversion. Use this code for Word DOCX to Byte Array conversion within any Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOCX to byte array via Java" h2="DOCX to byte array Java conversion for document data processing using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert DOCX to Byte Array via Java" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the Java developers to load & convert DOCX files to byte array for further manipulation tasks in just a few lines of code.
...
1.  To convert byte array to DOCX, Load byte array to ByteArrayInputStream
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOCX to byte array Java Conversion" offSpacer="" %}}

```cs
// Load the file.
Document docx = new Document("soureSample.docx");

// Create a new memory stream.
ByteArrayOutputStream out_Stream = new ByteArrayOutputStream();
// Save to stream.
docx.save(out_Stream, SaveFormat.DOCX);

// Convert the document to byte array form.
byte[] docx_Bytes = out_Stream.toByteArray();

// The bytes are now ready to be stored/processed.

// Now reverse the steps to load the bytes back into a document object.
ByteArrayInputStream in_Stream = new ByteArrayInputStream(docx_Bytes);

// Load the stream into a new document object.
Document load_Docx = new Document(in_Stream);
// Save the document.
load_Docx.save("convertback.docx",SaveFormat.DOCX);
...
A Document Processing Library to perform a wide range of document management and manipulation tasks including DOCX generation, editing, conversion, rendering and printing. .NET Word API supports all of word-processing formats as well as allows exporting or **converting DOCX to HTML**, PDF, fixed-layout and most commonly used image & multimedia formats.

---
title: Convert TXT to RTF via Java 
weight: 8550
url: /java/conversion/txt-to-rtf/ 
description: Sample Java conversion code for TXT format to RTF file. Programmers can use this example code for multiple TXT to RTF files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TXT to RTF via Java" h2="TXT to RTF Java conversion to convert single or multiple pages to RTF documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="RTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to RTF Using Java" %}}

 In order to render TXT to RTF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TXT to RTF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert TXT file to RTF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for TXT to RTF Conversion" offSpacer="" %}}

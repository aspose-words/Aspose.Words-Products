---
title: Convert FLATOPCMACROENABLED to PCL via Java 
url: /java/conversion/flatopcmacroenabled-to-pcl/ 
description: Sample Java conversion code for FLATOPCMACROENABLED format to PCL file. Programmers can use this example code for multiple FLATOPCMACROENABLED to PCL files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FLATOPCMACROENABLED to PCL via Java" h2="FLATOPCMACROENABLED to PCL Java conversion to convert single or multiple pages to PCL documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PCL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="FLATOPCMACROENABLEDX" fileiconsmall2="JPG" fileiconsmall3="PCL" fileiconsmall4="XML" fileiconsmall5="FLATOPCMACROENABLED" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert FLATOPCMACROENABLED to PCL Using Java" %}}

 In order to render FLATOPCMACROENABLED to PCL, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert FLATOPCMACROENABLED to PCL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert FLATOPCMACROENABLED file to PCL in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for FLATOPCMACROENABLED to PCL Conversion" offSpacer="" %}}

```cs
// load FLATOPCMACROENABLED with an instance of Document
Document document = new Document("template.xml");
// call Save method while passing SaveFormat.PCL
document.save("output.xml",SaveFormat.PCL);   

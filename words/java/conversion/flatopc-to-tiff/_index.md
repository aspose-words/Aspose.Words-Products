...
{{% blocks/products/pf/agp/text %}}
 ...
 Java developers can easily convert FLATOPC file to TIFF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for FLATOPC to TIFF Conversion" offSpacer="" %}}

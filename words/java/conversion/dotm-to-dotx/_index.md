...
{{% blocks/products/pf/agp/text %}}
 ...
 Java developers can easily convert DOTM file to DOTX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOTM to DOTX Conversion" offSpacer="" %}}

...
{{< blocks/products/pf/upper-banner h1="Convert HTML to DOT via Java" h2="Native Java library to export Microsoft Word & OpenOffice documents to DOT." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DOT" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert HTML to DOT Using Java" %}}
 ...
 In order to render HTML to DOT, weвЂ™ll use
...
{{% blocks/products/pf/agp/code-block title="Convert HTML to DOT - JavaвЂЋ" offSpacer="" %}}

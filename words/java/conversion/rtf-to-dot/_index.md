...
{{% blocks/products/pf/agp/content h2="How to Convert RTF to DOT Using Java" %}}

 In order to render RTF to DOT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert RTF to DOT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert RTF file to DOT in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for RTF to DOT Conversion" offSpacer="" %}}

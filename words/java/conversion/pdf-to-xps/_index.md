...
description: Sample Java conversion code for PDF format to XPS file. Programmers can use this example code for multiple PDF to XPS files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to XPS via Java" h2="PDF to XPS Java conversion to convert single or multiple pages to XPS documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PDFX" fileiconsmall2="JPG" fileiconsmall3="XPS" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Words API makes it easy for the developers to convert PDF file to XPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for PDF to XPS Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PDF to XPS Conversion Live Demos" sectionDescription="[Convert PDF to XPS](https://products.aspose.app/words/conversion/pdf-to-xps) right now by visiting our Live Demos website.The live demo has the following benefits" >}}

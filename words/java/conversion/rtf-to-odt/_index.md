---
title: Convert RTF to ODT via Java 
weight: 6850
url: /java/conversion/rtf-to-odt/ 
description: Sample Java conversion code for RTF format to ODT file. Programmers can use this example code for multiple RTF to ODT files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert RTF to ODT via Java" h2="RTF to ODT Java conversion to convert single or multiple pages to ODT documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODT" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RTF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert RTF to ODT Using Java" %}}

 In order to render RTF to ODT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert RTF to ODT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for RTF to ODT Conversion" offSpacer="" %}}

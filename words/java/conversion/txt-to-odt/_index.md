---
title: Convert TXT to ODT via Java 
weight: 7080
url: /java/conversion/txt-to-odt/ 
description: Sample Java conversion code for TXT format to ODT file. Programmers can use this example code for multiple TXT to ODT files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TXT to ODT via Java" h2="TXT to ODT Java conversion to convert single or multiple pages to ODT documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODT" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to ODT Using Java" %}}

 In order to render TXT to ODT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TXT to ODT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for TXT to ODT Conversion" offSpacer="" %}}

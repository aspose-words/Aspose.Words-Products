...
{{% blocks/products/pf/agp/content h2="How to Convert RTF to PS Using Java" %}}

 In order to render RTF to PS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert RTF to PS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert RTF file to PS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for RTF to PS Conversion" offSpacer="" %}}

...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to XPS Using Java" %}}

 In order to render DOC to XPS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to XPS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOC to XPS Conversion" offSpacer="" %}}

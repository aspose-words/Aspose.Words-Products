...
{{< blocks/products/pf/upper-banner h1="Convert DOC to MD via Java" h2="Native Java library to export Microsoft Word & OpenOffice documents to MD." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOC" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to MD Using Java" %}}
 ...
 In order to render DOC to MD, weвЂ™ll use
...
{{% blocks/products/pf/agp/code-block title="Convert DOC to MD - JavaвЂЋ" offSpacer="" %}}

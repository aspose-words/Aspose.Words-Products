...
{{% blocks/products/pf/agp/content h2="How to Convert HTML to RTF Using Java" %}}

 In order to render HTML to RTF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert HTML to RTF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert HTML file to RTF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for HTML to RTF Conversion" offSpacer="" %}}

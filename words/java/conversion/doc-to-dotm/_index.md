...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to DOTM Using Java" %}}

 In order to render DOC to DOTM, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to DOTM via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOC to DOTM Conversion" offSpacer="" %}}

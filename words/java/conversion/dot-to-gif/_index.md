...
{{% blocks/products/pf/agp/content h2="How to Convert DOT to GIF Using Java" %}}

 In order to render DOT to GIF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOT to GIF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOT to GIF Conversion" offSpacer="" %}}

...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to OPENXPS Using Java" %}}

 In order to render DOC to OPENXPS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to OPENXPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert DOC file to OPENXPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOC to OPENXPS Conversion" offSpacer="" %}}

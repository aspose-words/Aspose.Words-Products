...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to TXT Using Java" %}}

 In order to render DOC to TXT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to TXT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOC to TXT Conversion" offSpacer="" %}}

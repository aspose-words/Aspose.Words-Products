...
{{% blocks/products/pf/agp/content h2="How to Convert MOBI to GIF Using Java" %}}

 In order to render MOBI to GIF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MOBI to GIF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for MOBI to GIF Conversion" offSpacer="" %}}

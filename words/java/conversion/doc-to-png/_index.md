...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to PNG Using Java" %}}

 In order to render DOC to PNG, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to PNG via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOC to PNG Conversion" offSpacer="" %}}

---
title: Convert TXT to DOCM via Java 
weight: 8770
url: /java/conversion/txt-to-docm/ 
description: Sample Java conversion code for TXT format to DOCM file. Programmers can use this example code for multiple TXT to DOCM files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TXT to DOCM via Java" h2="TXT to DOCM Java conversion to convert single or multiple pages to DOCM documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCM" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to DOCM Using Java" %}}

 In order to render TXT to DOCM, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TXT to DOCM via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for TXT to DOCM Conversion" offSpacer="" %}}

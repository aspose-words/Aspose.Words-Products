...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to EPUB Using Java" %}}

 In order to render TXT to EPUB, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TXT to EPUB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert TXT file to EPUB in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for TXT to EPUB Conversion" offSpacer="" %}}

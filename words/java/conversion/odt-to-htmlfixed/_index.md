...
description: Sample Java conversion code for ODT format to HTMLFIXED file. Programmers can use this example code for multiple ODT to HTMLFIXED files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODT to HTMLFIXED via Java" h2="ODT to HTMLFIXED Java conversion to convert single or multiple pages to HTMLFIXED documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTMLFIXED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="ODTX" fileiconsmall2="JPG" fileiconsmall3="HTMLFIXED" fileiconsmall4="XML" fileiconsmall5="ODT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java developers can easily convert ODT file to HTMLFIXED in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for ODT to HTMLFIXED Conversion" offSpacer="" %}}

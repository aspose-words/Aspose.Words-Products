---
title: Convert RTF to WORDML via Java 
weight: 150
url: /java/conversion/rtf-to-wordml/ 
description: Sample Java conversion code for RTF format to WORDML file. Programmers can use this example code for multiple RTF to WORDML files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert RTF to WORDML via Java" h2="RTF to WORDML Java conversion to convert single or multiple pages to WORDML documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORDML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RTF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert RTF to WORDML Using Java" %}}

 In order to render RTF to WORDML, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert RTF to WORDML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert RTF file to WORDML in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for RTF to WORDML Conversion" offSpacer="" %}}

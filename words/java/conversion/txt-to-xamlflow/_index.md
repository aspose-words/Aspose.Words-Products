...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to XAMLFLOW Using Java" %}}

 In order to render TXT to XAMLFLOW, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TXT to XAMLFLOW via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert TXT file to XAMLFLOW in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for TXT to XAMLFLOW Conversion" offSpacer="" %}}

---
title: Convert DOCPREWORD60 to PS via Java 
url: /java/conversion/docpreword60-to-ps/ 
description: Sample Java conversion code for DOCPREWORD60 format to PS file. Programmers can use this example code for multiple DOCPREWORD60 to PS files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOCPREWORD60 to PS via Java" h2="DOCPREWORD60 to PS Java conversion to convert single or multiple pages to PS documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PS" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCPREWORD60X" fileiconsmall2="JPG" fileiconsmall3="PS" fileiconsmall4="XML" fileiconsmall5="DOCPREWORD60" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DOCPREWORD60 to PS Using Java" %}}

 In order to render DOCPREWORD60 to PS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOCPREWORD60 to PS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Words API makes it easy for the developers to convert DOCPREWORD60 file to PS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOCPREWORD60 to PS Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="DOCPREWORD60 to PS Conversion Live Demos" sectionDescription="[Convert DOCPREWORD60 to PS](https://products.aspose.app/words/conversion/docpreword60-to-ps) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your DOCPREWORD60 file, it will be converted instantly to PS." >}}

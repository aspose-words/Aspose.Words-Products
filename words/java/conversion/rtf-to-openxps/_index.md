---
title: Convert RTF to OPENXPS via Java 
weight: 70
url: /java/conversion/rtf-to-openxps/ 
description: Sample Java conversion code for RTF format to OPENXPS file. Programmers can use this example code for multiple RTF to OPENXPS files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert RTF to OPENXPS via Java" h2="RTF to OPENXPS Java conversion to convert single or multiple pages to OPENXPS documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OPENXPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RTF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert RTF to OPENXPS Using Java" %}}

 In order to render RTF to OPENXPS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert RTF to OPENXPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert RTF file to OPENXPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for RTF to OPENXPS Conversion" offSpacer="" %}}

---
title: Convert MOBI to XPS via Java 
weight: 3320
url: /java/conversion/mobi-to-xps/ 
description: Sample Java conversion code for MOBI format to XPS file. Programmers can use this example code for multiple MOBI to XPS files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MOBI to XPS via Java" h2="MOBI to XPS Java conversion to convert single or multiple pages to XPS documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MOBI" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MOBI to XPS Using Java" %}}

 In order to render MOBI to XPS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MOBI to XPS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for MOBI to XPS Conversion" offSpacer="" %}}

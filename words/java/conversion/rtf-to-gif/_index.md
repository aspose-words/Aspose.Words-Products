...
{{% blocks/products/pf/agp/content h2="How to Convert RTF to GIF Using Java" %}}

 In order to render RTF to GIF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert RTF to GIF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java source code for RTF to GIF Conversion" offSpacer="" %}}

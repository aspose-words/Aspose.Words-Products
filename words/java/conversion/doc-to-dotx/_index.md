...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to DOTX Using Java" %}}

 In order to render DOC to DOTX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to DOTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert DOC file to DOTX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOC to DOTX Conversion" offSpacer="" %}}

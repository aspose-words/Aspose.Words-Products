...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to PS Using Java" %}}

 In order to render DOC to PS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to PS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert DOC file to PS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for DOC to PS Conversion" offSpacer="" %}}

...
{{% blocks/products/pf/agp/content h2="How to Convert MOBI to RTF Using Java" %}}

 In order to render MOBI to RTF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MOBI to RTF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert MOBI file to RTF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for MOBI to RTF Conversion" offSpacer="" %}}

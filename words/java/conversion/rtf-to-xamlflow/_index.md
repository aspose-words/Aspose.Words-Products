...
{{% blocks/products/pf/agp/content h2="How to Convert RTF to XAMLFLOW Using Java" %}}

 In order to render RTF to XAMLFLOW, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert RTF to XAMLFLOW via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert RTF file to XAMLFLOW in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for RTF to XAMLFLOW Conversion" offSpacer="" %}}

...
{{< blocks/products/pf/upper-banner h1="Convert TXT to DOCX via Java" h2="Native Java library to export Microsoft Word & OpenOffice documents to DOCX." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to DOCX Using Java" %}}

 In order to render TXT to DOCX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TXT to DOCX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Convert TXT to DOCX - Java‎" offSpacer="" %}}

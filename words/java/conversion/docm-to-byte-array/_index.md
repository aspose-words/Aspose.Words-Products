---
title: Convert DOCM to Byte Array via Java 
weight: 7690
url: /java/conversion/docm-to-byte-array/ 
description: Java example code for DOCM to Byte Array conversion. Use this code for Word DOCM to Byte Array conversion within any Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOCM to byte array via Java" h2="DOCX to byte array Java conversion for document data processing using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert DOCM to Byte Array via Java" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the Java developers to load & convert DOCM files to byte array for further manipulation tasks in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load input DOCM File
...
1.  To convert byte array to DOCM, Load byte array to ByteArrayInputStream
1.  Load stream into Document Object
1.  Use save method with output file path and SaveFormat.DOCM 
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DOCM to byte array Java Conversion" offSpacer="" %}}

```cs
// Load the file.
Document docm = new Document("soureSample.docm");

// Create a new memory stream.
ByteArrayOutputStream out_Stream = new ByteArrayOutputStream();
// Save to stream.
docm.save(out_Stream, SaveFormat.DOCM);

// Convert the document to byte array form.
byte[] docm_Bytes = out_Stream.toByteArray();

// The bytes are now ready to be stored/processed.

// Now reverse the steps to load the bytes back into a document object.
ByteArrayInputStream in_Stream = new ByteArrayInputStream(docm_Bytes);

// Load the stream into a new document object.
Document load_Docm = new Document(in_Stream);
// Save the document.
load_Docm.save("convertback.docm",SaveFormat.DOCM);
...
A Document Processing Library to perform a wide range of document management and manipulation tasks including DOCM generation, editing, conversion, rendering and printing. .NET Word API supports all of word-processing formats as well as allows exporting or **converting DOCM to HTML**, PDF, fixed-layout and most commonly used image & multimedia formats.

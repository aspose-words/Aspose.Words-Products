...
description: Sample Java conversion code for FLATOPCTEMPLATE format to DOTM file. Programmers can use this example code for multiple FLATOPCTEMPLATE to DOTM files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FLATOPCTEMPLATE to DOTM via Java" h2="FLATOPCTEMPLATE to DOTM Java conversion to convert single or multiple pages to DOTM documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="FLATOPCTEMPLATEX" fileiconsmall2="JPG" fileiconsmall3="DOTM" fileiconsmall4="XML" fileiconsmall5="FLATOPCTEMPLATE" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java developers can easily convert FLATOPCTEMPLATE file to DOTM in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for FLATOPCTEMPLATE to DOTM Conversion" offSpacer="" %}}

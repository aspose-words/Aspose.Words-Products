...
{{% blocks/products/pf/agp/content h2="How to Convert RTF to DOTX Using Java" %}}

 In order to render RTF to DOTX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert RTF to DOTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert RTF file to DOTX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Java source code for RTF to DOTX Conversion" offSpacer="" %}}

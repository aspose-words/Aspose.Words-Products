---
title: Convert PDF to PS via Java 
url: /java/conversion/pdf-to-ps/ 
description: Sample Java conversion code for PDF format to PS file. Programmers can use this example code for multiple PDF to PS files conversion within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to PS via Java" h2="PDF to PS Java conversion to convert single or multiple pages to PS documents using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PS" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PDFX" fileiconsmall2="JPG" fileiconsmall3="PS" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to PS Using Java" %}}

 In order to render PDF to PS, we’ll use
...
{{% blocks/products/pf/agp/code-block title="Java source code for PDF to PS Conversion" offSpacer="" %}}

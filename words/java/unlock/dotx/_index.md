...
description: Java source code to unlock password protected DOTX file on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Unlock DOTX Files via Java" h2="Remove protection from Word documents including DOTX file using Java Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOTX" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Remove Protection DOTX File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to unlock DOTX via Java" %}}
...
// Load a DOTX file
Document doc = new Document("protectedFile.dotx");

// Unprotect
doc.unprotect();

// Save the document
doc.save("UnlockedFile.dotx");

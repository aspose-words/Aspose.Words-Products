...
{{% blocks/products/pf/agp/content h2="How to Parse RTF File Using Java" %}}
 ...
 In order to parse Microsot Word RTF file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Parse Microsoft Word RTF Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Parse RTF Files - Java" offSpacer="" %}}

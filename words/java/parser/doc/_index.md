...
{{% blocks/products/pf/agp/content h2="How to Parse DOC File Using Java" %}}
 ...
 In order to parse DOC file, weвЂ™ll use
...
{{% blocks/products/pf/agp/code-block title="ParseВ DOC Files - Java" offSpacer="" %}}

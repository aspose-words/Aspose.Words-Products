...
description: Try our On-Premise document digital signature APIs to eSgin DOT documents on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="eSign DOT Formats in Java" h2="Native and high performance DOT document electronic signature using server-side Aspose.Words for Java APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="DOT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Digitally Sign DOT File Using Java" %}}

 In order to digitally sign DOT file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for e-Signing DOT Files in Java" %}}
...
DigitalSignatureUtil.sign("Document.NewSignatureLine.dot", "Document.NewSignatureLine.dot_out.dot", certHolder, signOptions);  

...
{{% blocks/products/pf/agp/content h2="How to Digitally Sign DOTX File Using Java" %}}

 In order to digitally sign DOTX file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for e-Signing DOTX Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="e-Sign DOTX Files - Java" offSpacer="" %}}

```cs
Document doc = new Document();
DocumentBuilder builder = new DocumentBuilder(doc);
SignatureLine signatureLine = builder.insertSignatureLine(new SignatureLineOptions()).getSignatureLine();
doc.save("Document.NewSignatureLine.dotx");
...
DigitalSignatureUtil.sign("Document.NewSignatureLine.dotx", "Document.NewSignatureLine.dotx_out.dotx", certHolder, signOptions);  

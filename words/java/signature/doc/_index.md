...
{{% blocks/products/pf/agp/content h2="How to Digitally Sign DOC File Using Java" %}}

 In order to digitally sign DOC file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for e-Signing DOC Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="e-Sign DOC Files - Java" offSpacer="" %}}

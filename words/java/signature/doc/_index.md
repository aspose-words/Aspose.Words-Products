...
{{% blocks/products/pf/agp/content h2="How to Digitally Sign DOC File Using Java" %}}
 ...
 In order to digitally sign DOC file, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps forВ e-SigningВ DOC Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="e-SignВ DOC Files - Java" offSpacer="" %}}

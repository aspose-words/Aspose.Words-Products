...
{{% blocks/products/pf/agp/feature-section-col title="How to Create Word DOCM File Using Template via Java" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to creat DOCM files from template using ReportingEngine within running Word Automation applications for data processing in just a few lines of code. Reporting Engine supports different data sources including XML, JSON and CSV data.
...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a Word DOCM file from template using Java." offSpacer="" %}}
...
///
// Create Document object and initialize with DOCM template.
...
// Build report.
engine.buildReport(docm, sender, "s");

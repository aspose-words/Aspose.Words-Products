...
description: Try our On-Premise document report creation APIs to create DOT format reports on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Bulk Report Generation in DOT Format via Java" h2="Generate reports in DOT format using data source & a template." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/words/272x272/aspose_words-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DOT" pfName="Aspose.Words" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Generate DOT Reports Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Generate DOT Reports via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Generate Word Reports in DOT Format - C#" offSpacer="" %}}

```cs
// Create Document object and initialize with DOT template.
...
// Build report.
engine.buildReport(dot, sender, "s");
// Save as DOT document.
dot.save("word.dot");

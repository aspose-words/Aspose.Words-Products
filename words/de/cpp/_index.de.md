...
{{< blocks/products/pf/i18n/upper-banner h1="C++-API zur Verarbeitung von Word-Dokumenten" h2="Generieren, bearbeiten, konvertieren und rendern Sie Microsoft Word-Dokumente in einer C++-Anwendung, ohne Microsoft Word zu benötigen." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-cpp.svg" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/words/cpp" >}}
...
<p><strong>Aspose.Words for C++</strong> ist eine fortschrittliche API zur Verarbeitung von Word-Dokumenten, mit der eine Vielzahl von Verarbeitungsaufgaben ausgeführt werden können. Die API von Words bietet Dokumentformatierung, Bearbeitung, Seriendruck, Wasserzeichen und viele weitere Funktionen direkt in Ihren eigenen C++-Anwendungen, ohne dass Microsoft Word erforderlich ist.</p>
<p>Die Aspose.Words-API unterstützt die meisten Microsoft Word-Formate und kann die Dokumentseiten in eine Reihe von Bildformaten rendern. So können Sie mit Dokumenten in DOC, DOCX, PDF, RTF, DOT, DOTX, DOTM, DOCM, FlatOPC, ODT, OTT, HTML, MHTML, MOBI, TXT, XPS, PS, TIFF, JPEG, PNG, BMP, SVG, EMF, GIF, PCL, EPUB, XML, XAML und mehr. Du kannst sehen <a href="https://docs.aspose.com/words/cpp/supported-document-formats/">die vollständige Liste der unterstützten Formate</a>.</p>
<h2 class="h2title">Functionality of Aspose.Words for C++</h2>
<p>Aspose.Words ist eine eigenständige C++-Bibliothek. Sie müssen keine zusätzlichen Anwendungen installieren, damit Ihr C++-Code funktioniert. Diese C++-API basiert auf der <a href="https://docs.aspose.com/words/cpp/aspose-words-document-object-model/">Dokumentobjektmodell (DOM)</a> um auf Dokumentknoten und -elemente zuzugreifen.</p>
{{< /blocks/products/pf/i18n/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/i18n/carousel >}}

{{< blocks/products/pf/carousel-item h3="Auf einen Blick" description="Eine allgemeine Ansicht der Möglichkeiten der API." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Abschnitte, Kopf- und Fußzeilen
    </li>
    <li>
     Fußnoten, Endnoten und Kommentare
    </li>
   </ul>
  </div>
  <!--/right-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++-Textverarbeitungsbibliothek" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Plattformunabhängigkeit" description="Die Bibliothek unterstützt vollständig C++-Anwendungen, die auf den folgenden Plattformen entwickelt wurden [System Anforderungen](https://docs.aspose.com/words/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="APIs zur Bearbeitung von Word-Dokumenten" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Unterstützte Dateiformate" description="Aspose.Words für C++ unterstützt die gängigsten [Textverarbeitungsdateiformate](https://docs.aspose.com/words/cpp/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ Word-Programmier-APIs" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Erweiterte C++ Word-API-Funktionen
   </h2>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/convert-a-document/">Konvertieren Sie ein Dokument</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/rendering/">Rendern eines Dokuments in Formate mit festem Layout</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/compare-documents/">Dokumente vergleichen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/clone-a-document/">Klonen Sie ein Dokument</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/insert-and-append-documents/">Dokumente zusammenfügen: einfügen und anhängen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/split-a-document/">Dateien teilen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/find-and-replace/">Text suchen und ersetzen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/protect-or-encrypt-a-document/">Ein Dokument schützen oder verschlüsseln</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-digital-signatures/">Arbeiten Sie mit digitalen Signaturen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/mail-merge-and-reporting/">Seriendruck und Berichterstellung</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-watermark/">Wasserzeichen zu einem Dokument hinzufügen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-tables/">Arbeiten Sie mit Tabellen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-fields/">Felder einfügen, aktualisieren oder entfernen</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/programming-with-documents/">Alle Dokumentelemente formatieren</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-comments/">Arbeiten Sie mit Kommentaren und Überarbeitungen</a>
    </p>
   </div>
   <div>
   <p>
     Bitte beachten Sie, dass die Liste nicht vollständig ist und Sie weitere Funktionen und Beschreibungen in der finden können <a href="https://docs.aspose.com/words/cpp/developer-guide/">documentation</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Programmierung mit Document Object Model
    </h2>
    <p>
     ...
     Die API ermöglicht es C++-Anwendungen, die Erstellung von Microsoft Word-Dateien zu automatisieren sowie Dateien zu öffnen und zu ändern, einschließlich der Formatierung mit einem intuitiven Dokumentobjektmodell, das Microsoft Word in Terminologie und Funktionen nachahmt. C++-Entwickler können alle Elemente dynamisch erstellen, ändern, extrahieren und ersetzen, einschließlich Abschnitte, Absätze, Tabellen, Lesezeichen, Felder, Formularfelder, Kommentare, Bilder, Stile und so weiter.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Konvertieren Sie eine Datei mit nur zwei Codezeilen von einem unterstützten Format in ein anderes. Es ist so einfach!
    </p>
...
doc->Save(outputPath);
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Verknüpfen oder Anhängen von Dokumenten in C++
    </h2>
    <p>
     Aspose.Words für C++ unterstützt das Verbinden und Anhängen mehrerer Dateien zu einer. Dieser Prozess ist sehr einfach und konfigurierbar und bietet die Möglichkeit, zu steuern, wie die Dateien zusammengefügt werden. Die C++-Textverarbeitungsbibliothek ermöglicht auch das Zurücksetzen der Seitennummerierung nach dem Zusammenfügen der Dokumente.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Zwei Dateien zusammenführen – C++
     </h3>
     <pre><code class="cpp">
...
// Die Quelldatei mit den in der Quelldatei gefundenen Originalstilen anhängen.
...
dstDoc->Save(dir + u"output.doc);</code></pre>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Verwenden Sie den Dokumentenschutz in C++
    </h2>
    <p>
     Aspose.Words für C++ bietet die Möglichkeit, Dokumente mit einer einzigen Codezeile zu schützen und den Schutz aufzuheben. Sie können den Schutz so einstellen, dass der Benutzer nur begrenzte Änderungen vornehmen kann, z. B. das Hinzufügen von Anmerkungen, das Vornehmen von Überarbeitungen oder das Ausfüllen eines Formulars.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Dateien schützen und Schutz aufheben – C++
     </h3>
     <pre><code class="cpp">
// Zu verarbeitendes Dokument laden.
auto wrdoc = System::MakeObject&lt;Document&gt;(dir + u"template.doc");

// Datei schützen.
wrdoc->Protect(ProtectionType::AllowOnlyFormFields, u"password");

// Schutz der Datei aufheben.
wrdoc->Unprotect();
</code></pre>
    </div>
   </div>
...
{{< blocks/products/pf/slr-element name="Dokumentation" href="https://docs.aspose.com/words/cpp/" >}}
{{< blocks/products/pf/slr-element name="Quellcode" href="https://github.com/aspose-words/Aspose.Words-for-C" >}}
{{< blocks/products/pf/slr-element name="API-Referenzen" href="https://apireference.aspose.com/words/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.Words für C++?" tabId="success-stories" >}}

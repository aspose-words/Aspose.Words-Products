---
title: Exportieren Sie Berichte in Word-Dateien in JasperReports & JasperServer 
weight: 10660

description: Exportieren Sie Berichte aus Jasper Reports und JasperServer in die Formate Word DOC Office Open XML OOXML DOCX RTF ODT HTML MHTML und TXT
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="JasperReports-Erweiterung zum Exportieren von Berichten im Word-Format" h2="Exportieren Sie Berichte aus JasperReports und JasperServer in Word- und HTML-Formate." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-jasperreports.svg" pfName="Aspose.Words" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/words/jasperreports" >}}
...
<p>
 Aspose.Words for JasperReports ist die einzige Lösung auf dem Markt, die es ermöglicht, Berichte von JasperReports und JasperServer in Microsoft Word-Dokumente (DOC), Office Open XML (OOXML, DOCX), Rich Text Format (RTF), OpenDocument Text ( ODT), Webseiten- (HTML) und Nur-Text-Formate (TXT) ohne Verwendung von Microsoft Word. Alle Berichtsfunktionen mit höchster Genauigkeit können in eine Microsoft Word-Datei konvertiert werden.
</p>
...
{{< blocks/products/pf/carousel-item h3="Auf einen Blick" description="Die Funktionen von Aspose.Words für JasperReports." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformunabhängigkeit" description="Aspose.Words für JasperReports unterstützt J2SE, JasperReports und JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
  ...
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 3.0 oder höher
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
    </i>
    JasperServer 3.7.1 oder höher
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports Server 7.1.0 oder höher
   </header>
  </div>
  <!--/right-->
 </div>
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="JasperReports-zu-DOC-Konverter" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Unterstützte Dateiformate" description="Aspose.Words for JasperReports unterstützt die gängigsten Textverarbeitungs-, Text- und Webanwendungen [Dateiformate](https://docs.aspose.com/words/jasperreports/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="JasperReports Exporter für Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <div class="col-lg-12">
    <h2 class="h2title">
     Unterstützung für die gängigsten Microsoft Word-Formate
    </h2>
    <p>
     Mit Aspose.Words for JasperReports können Sie Berichte als DOC- und DOCX-Dokumente aus JasperReports und JasperServer exportieren. Im Vergleich zu RTF bieten diese Formate eine Reihe von Vorteilen, wie z. B. kleinere Dateigröße, bessere Inhaltsformatierung und einfache Bearbeitung durch Endbenutzer.
    </p>
    <p>
     Zusätzlich zu den Microsoft Word-Formaten bietet Aspose.Words for JasperReports die Möglichkeit, die Berichte in den Formaten RTF, ODT, HTML und TXT zu exportieren.
    </p>
   </div>
   <!--
...
<h2 class="h2title">Easy & Leichte Bereitstellung</h2>
...
-->
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Words for JasperReports exportiert die Berichte so in Microsoft Word-Dokumente, dass das Ergebnis mit dem ursprünglichen Berichtsdesign identisch erscheint, wie es vom integrierten JasperReports-Berichtsdesigner erstellt wurde. Alle Berichtsfunktionen werden mit höchster Präzision konvertiert, damit Microsoft Word-Dokumente so originalgetreu wie möglich aussehen.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words for JasperReports exportiert Flusslayoutdokumente. Das heißt, Dokumente bestehen aus "
     <strong>
      normal
     </strong>
     " Absätze, Tabellen und Bilder, die bei Bedarf einfach in Microsoft Word weiterbearbeitet werden können. Der in JasperReports integrierte RTF-Exporter erstellt Dokumente, die aus positionierten Textrahmen bestehen, was die Bearbeitung durch Endbenutzer zu einer weniger intuitiven Aufgabe macht.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Words für JasperReports wird mit verwaltetem Code erstellt, für den niemals Microsoft Word auf dem Computer installiert sein muss, um mit Word-Dokumentformaten zu arbeiten. Es ist eine perfekte Microsoft Word-Automatisierungsalternative in Bezug auf unterstützte Funktionen, Sicherheit, Stabilität, Skalierbarkeit, Geschwindigkeit und Preis.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.Words für JasperReports?" tabId="success-stories" >}}

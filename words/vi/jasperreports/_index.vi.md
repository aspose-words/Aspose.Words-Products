...
{{< blocks/products/pf/i18n/upper-banner h1="Tiện ích mở rộng JasperReports để xuất báo cáo ở định dạng Word" h2="Xuất báo cáo sang định dạng Word và HTML từ JasperReports và JasperServer." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-jasperreports.svg" pfName="Aspose.Words" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/words/jasperreports" >}}
...
{{< blocks/products/pf/carousel-item h3="Sơ lược" description="Các tính năng của Aspose. AdWords dành cho JasperReports." >}}
...
{{< blocks/products/pf/carousel-item h3="Nền tảng độc lập" description="Aspose. AdWords dành cho JasperReports hỗ trợ J2SE, JasperReports và JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
  ...
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 3.0 hoặc cao hơn
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
    </i>
    JasperServer 3.7.1 hoặc cao hơn
   </header>
   <br/>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports Server 7.1.0 hoặc cao hơn
   </header>
  </div>
  <!--/right-->
 </div>
...
{{< blocks/products/pf/carousel-item h3="Định dạng tệp được hỗ trợ" description="Aspose. AdWords for JasperReports hỗ trợ xử lý Word, văn bản và web phổ biến nhất [định dạng tệp](https://docs.aspose.com/words/jasperreports/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-jasper">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="JasperReports Exporter cho Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-jasperreports.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<h2 class="h2title">Easy & Triển khai nhẹ</h2>
...
-->
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose. AdWords for JasperReports xuất các tài liệu bố cục luồng. Điều này có nghĩa là các tài liệu bao gồm "
     <strong>
      thông thường
     </strong>
     " các đoạn văn, bảng và hình ảnh dễ dàng chỉnh sửa thêm trong Microsoft Word, nếu cần. Trình xuất JasperReports RTF được tích hợp sẵn tạo ra các tài liệu bao gồm các khung văn bản được định vị, giúp cho việc chỉnh sửa bởi người dùng cuối trở thành một nhiệm vụ ít trực quan hơn.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Tài liệu" href="https://docs.aspose.com/words/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao Aspose. AdWords dành cho JasperReports?" tabId="success-stories" >}}

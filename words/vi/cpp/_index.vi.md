...
{{< blocks/products/pf/i18n/upper-banner h1="API xử lý tài liệu từ C++" h2="Tạo, chỉnh sửa, chuyển đổi và hiển thị tài liệu Microsoft Word trong ứng dụng C++ mà không yêu cầu Microsoft Word." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/words/headers/aspose_words-for-cpp.svg" pfName="Aspose.Words" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/words/cpp" >}}
...
<p><strong>Aspose.Words for C++</strong> là một API xử lý tài liệu Word nâng cao để thực hiện một loạt các tác vụ xử lý. API của Words cung cấp định dạng tài liệu, thao tác, trộn thư, đánh dấu màu nước và nhiều khả năng khác ngay trong các ứng dụng C++ của riêng bạn mà không yêu cầu Microsoft Word.</p>
<p>API Aspose. AdWords hỗ trợ hầu hết các định dạng Microsoft Word và có thể hiển thị các trang tài liệu sang một số định dạng hình ảnh. Do đó, bạn có thể làm việc với các tài liệu trong DOC, DOCX, PDF, RTF, DOT, DOTX, DOTM, DOCM, FlatOPC, ODT, OTT, HTML, MHTML, MOBI, TXT, XPS, PS, TIFF, JPEG, PNG, BMP, SVG, EMF, GIF, PCL, EPUB, XML, XAML và hơn thế nữa. Bạn có thể thấy <a href="https://docs.aspose.com/words/cpp/supported-document-formats/">danh sách đầy đủ các định dạng được hỗ trợ</a>.</p>
<h2 class="h2title">Functionality of Aspose.Words for C++</h2>
<p>Aspose.Words là một thư viện C++ độc lập. Bạn không cần phải cài đặt các ứng dụng bổ sung để mã C++ của bạn hoạt động. API C++ này dựa trên <a href="https://docs.aspose.com/words/cpp/aspose-words-document-object-model/">Mô hình đối tượng tài liệu (DOM)</a> để truy cập các nút và phần tử của tài liệu.</p>
{{< /blocks/products/pf/i18n/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/i18n/carousel >}}

{{< blocks/products/pf/carousel-item h3="Sơ lược" description="Một cái nhìn chung về các khả năng của API." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Chú thích cuối trang, chú thích cuối và chú thích
    </li>
   </ul>
  </div>
  <!--/right-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Thư viện xử lý văn bản C++" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Nền tảng độc lập" description="Thư viện hỗ trợ đầy đủ các ứng dụng C++ được phát triển trên các nền tảng sau [yêu cầu hệ thống](https://docs.aspose.com/words/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API thao tác tài liệu Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Các định dạng tệp được hỗ trợ" description="Aspose. AdWords dành cho C++ hỗ trợ phổ biến nhất [Định dạng tệp Xử lý văn bản](https://docs.aspose.com/words/cpp/supported-document-formats/)." >}}
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API lập trình C++ Word" class="lazyloaded" src="https://www.aspose.cloud/templates/aspose/img/products/words/aspose_words-for-cpp.svg"/>
  <header>
   Aspose.Words
  </header>
  <footer>
...
<div class="row app-styles">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/convert-a-document/">Chuyển đổi tài liệu</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/rendering/">Kết xuất tài liệu đến các định dạng bố cục cố định</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/compare-documents/">So sánh tài liệu</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/clone-a-document/">Sao chép tài liệu</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/insert-and-append-documents/">Tham gia tài liệu: chèn và nối</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/split-a-document/">Tách tệp</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/find-and-replace/">Tìm và thay thế văn bản</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/protect-or-encrypt-a-document/">Bảo vệ hoặc mã hóa tài liệu</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-digital-signatures/">Làm việc với Chữ ký kỹ thuật số</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/mail-merge-and-reporting/">Hợp nhất Thư và Báo cáo</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-watermark/">Thêm hình mờ vào tài liệu</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-tables/">Làm việc với bảng</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-fields/">Chèn, Cập nhật hoặc Loại bỏ Trường</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/programming-with-documents/">Định dạng tất cả các phần tử tài liệu</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     <a href="https://docs.aspose.com/words/cpp/working-with-comments/">Làm việc với Nhận xét và Bản sửa đổi</a>
    </p>
   </div>
   <div>
   <p>
     Xin lưu ý rằng danh sách này chưa đầy đủ và bạn có thể tìm thấy các tính năng và mô tả khác trong <a href="https://docs.aspose.com/words/cpp/developer-guide/">documentation</a>.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Tài liệu" href="https://docs.aspose.com/words/cpp/" >}}
{{< blocks/products/pf/slr-element name="Mã nguồn" href="https://github.com/aspose-words/Aspose.Words-for-C" >}}
{{< blocks/products/pf/slr-element name="Tham chiếu API" href="https://apireference.aspose.com/words/cpp" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao Aspose. AdWords dành cho C++?" tabId="success-stories" >}}
